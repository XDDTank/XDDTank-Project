...
//roomLoading.view.RoomLoadingPrgressItem
...
package roomLoading.view
{
    ...
    public class RoomLoadingPrgressItem extends Sprite implements Disposeable 
    {
        ...
        public function RoomLoadingPrgressItem(_arg_1:RoomPlayer, _arg_2:GameInfo, _arg_3:int=1)
        {
            this._info = _arg_1;
        ...
        private function __onProgress(_arg_1:RoomPlayerEvent):void
        {
        ...
        {
            var _local_1:String = ((this._info.team == RoomPlayer.BLUE_TEAM) ? "blueTeam" : "redTeam");
            if (this._info.team == RoomPlayer.BLUE_TEAM)
            {
                if (((this._info.isSelf) || ((this.blueIdx == 1) && (!(this._info.team == RoomPlayer.BLUE_TEAM)))))
                {
                    PositionUtils.setPos(this._perecentageTxt, (((((("asset.roomLoadingPlayerItem." + _local_1) + "_") + 1) + "_") + this._vsType) + ".progressPos"));
                    PositionUtils.setPos(this._okTxt, (((((("asset.roomLoadingPlayerItem." + _local_1) + "_") + 1) + "_") + this._vsType) + ".progressPos"));
                    if (this._info.team != RoomPlayer.BLUE_TEAM)
                    {
                        this.blueIdx++;
                    };
                ...
                else
                {
                    ...
                    PositionUtils.setPos(this._perecentageTxt, (((((("asset.roomLoadingPlayerItem." + _local_1) + "_") + this.index) + "_") + this._vsType) + ".progressPos"));
                    PositionUtils.setPos(this._okTxt, (((((("asset.roomLoadingPlayerItem." + _local_1) + "_") + this.blueIdx) + "_") + this._vsType) + ".progressPos"));
                    this.blueIdx++;
                };
            }
            else
            {
                if (((this._info.isSelf) || ((this.index == 1) && (!(this._info.team == RoomPlayer.RED_TEAM)))))
                {
                    PositionUtils.setPos(this._perecentageTxt, (((((("asset.roomLoadingPlayerItem." + _local_1) + "_") + 1) + "_") + this._vsType) + ".progressPos"));
                    PositionUtils.setPos(this._okTxt, (((((("asset.roomLoadingPlayerItem." + _local_1) + "_") + 1) + "_") + this._vsType) + ".progressPos"));
                ...
                else
                {
                    ...
                    PositionUtils.setPos(this._perecentageTxt, (((((("asset.roomLoadingPlayerItem." + _local_1) + "_") + this.index) + "_") + this._vsType) + ".progressPos"));
                    PositionUtils.setPos(this._okTxt, (((((("asset.roomLoadingPlayerItem." + _local_1) + "_") + this.index) + "_") + this._vsType) + ".progressPos"));
                    this.redIdx++;
                };
            };
        }
