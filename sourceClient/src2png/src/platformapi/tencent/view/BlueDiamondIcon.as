...
//platformapi.tencent.view.BlueDiamondIcon
...
package platformapi.tencent.view
{
    ...
    public class BlueDiamondIcon extends Component implements IDiamondIcon 
    {

        private var _diamond:ScaleFrameImage;
        private var _level:int;

        public function BlueDiamondIcon()
        {
            this._diamond = UICreatShortcut.creatAndAdd("platformapi.tencent.blueDiamondIcon", this);
        }
