...
package farm.view
{
    ...
    public class FarmMainView extends Sprite implements Disposeable 
    {
        ...
        protected function __levelUp(_arg_1:PlayerPropertyEvent):void
        {
        ...
        protected function __progressPlay(_arg_1:Event):void
        {
        }

        protected function __beginSeed(_arg_1:FarmEvent):void
        {
            _arg_1.stopImmediatePropagation();
            this._seedVo = (_arg_1.data as FieldVO);
            if ((!(this._seedVo)))
            {
                return;
            };
        ...
        {
            var _local_2:FarmFieldBlock = (_arg_1.target.parent as FarmFieldBlock);
            if ((((_local_2) && (_local_2.isDig)) || (_arg_1.target == this._seedButton)))
            {
        ...
        protected function __pastureOut(_arg_1:MouseEvent):void
        {
            this._pastureHouseBtn.gotoAndStop(1);
        }

        protected function __pastureOver(_arg_1:MouseEvent):void
        {
            this._pastureHouseBtn.gotoAndStop(2);
        }

        protected function __enterFram(_arg_1:FarmEvent):void
        {
            this._farmName.text = FarmModelController.instance.model.currentFarmerName;
            this.petFarmGuilde();
        }
