...
package im
{
    ...
    public class IMLookupItem extends Sprite implements Disposeable 
    {
        ...
        public function IMLookupItem(_arg_1:Object)
        {
            this._info = _arg_1;
            super();
            this.init();
        ...
        private function init():void
        {
            ...
            var _local_1:Point = ComponentFactory.Instance.creatCustomObject("IM.IMLookup.SexPos");
            this._sex_icon.x = _local_1.x;
            this._sex_icon.y = _local_1.y;
        ...
        private function __bgClick(_arg_1:InteractiveEvent):void
        {
            SoundManager.instance.play("008");
        ...
        private function _deleteBtnClick(_arg_1:MouseEvent):void
        {
            SoundManager.instance.play("008");
        ...
        private function __privateChatClick(_arg_1:InteractiveEvent):void
        {
            SoundManager.instance.play("008");
        ...
        private function __privateChatBtnClick(_arg_1:MouseEvent):void
        {
            ...
            {
                if (((this.info is CMFriendInfo) && (this.info.IsExist)))
                {
