...
package pet.date
{
    ...
    public class PetSkillInfo extends EventDispatcher 
    {
        ...
        public function set BallType(_arg_1:int):void
        {
            this._ballType = _arg_1;
        }
        ...
        public function set EffectPic(_arg_1:String):void
        {
            this._effectPic = _arg_1;
        }
        ...
        public function set EffectDelay(_arg_1:int):void
        {
            this._EffectDelay = _arg_1;
        }
