...
package email.view
{
    ...
    public class EmailView extends Sprite implements Disposeable 
    {
        ...
        public function setup(_arg_1:MailManager, _arg_2:EmailModel):void
        {
        ...
        private function __changeType(_arg_1:EmailEvent):void
        {
            this._read.switchBtnsVisible((!(this._model.mailType == EmailState.SENDED)));
            this.updateListView();
        }

        private function __changeState(_arg_1:EmailEvent):void
        {
        ...
        private function __changePage(_arg_1:EmailEvent):void
        {
            this.updateListView();
        }

        private function __selectEmail(_arg_1:EmailEvent):void
        {
            this._read.info = _arg_1.info;
            if (_arg_1.info == null)
            {
        ...
        private function __removeEmail(_arg_1:EmailEvent):void
        {
            this.updateListView();
        }

        private function __initEmail(_arg_1:EmailEvent):void
        {
            this.updateListView();
        }
