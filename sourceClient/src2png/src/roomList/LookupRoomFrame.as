...
package roomList
{
    ...
    public class LookupRoomFrame extends BaseAlerFrame implements Disposeable 
    {
        ...
        public function LookupRoomFrame(_arg_1:int)
        {
            this._roomId = _arg_1;
            this.initContainer();
            this.initEvent();
        ...
        private function initContainer():void
        {
            ...
            _local_1.title = LanguageMgr.GetTranslation("tank.roomlist.RoomListIIFindRoomPanel.search");
            info = _local_1;
