...
//roomList.pvpRoomList.RoomListCreateRoomView
...
package roomList.pvpRoomList
{
    ...
    public class RoomListCreateRoomView extends BaseAlerFrame implements Disposeable 
    {
        ...
        protected function initContainer():void
        {
            ...
            _local_1.graphics.drawRect(this._explainTxt.x, this._explainTxt.y, this._explainTxt.width, this._explainTxt.height);
            ...
            this._passTxt.text = "";
            this._passTxt.textField.restrict = "0-9A-Za-z";
        ...
        protected function __passBtnClick(_arg_1:MouseEvent):void
        {
            SoundManager.instance.play("008");
        ...
        private function __passKeyDown(_arg_1:KeyboardEvent):void
        {
