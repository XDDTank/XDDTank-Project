...
//petsBag.view.item.PetSkillLevelUpItem
...
package petsBag.view.item
{
    ...
    public class PetSkillLevelUpItem extends Component 
    {
        ...
        public function PetSkillLevelUpItem(_arg_1:int)
        {
            this._place = _arg_1;
            super();
            this.initEvent();
        ...
        public function set info(_arg_1:PetSkillItemInfo):void
        {
            this._info = _arg_1;
            ...
            if (((!(this._lastSkill)) || (!(this._lastSkill.skillInfo.Pic == this._templeteInfo.skillInfo.Pic))))
            {
                ...
                this._bg.setFrame(((this._info.skillID < 1000) ? 1 : 2));
            ...
            this._lastLevel = ((this.isLearning) ? this._templeteInfo.SkillLevel : 0);
