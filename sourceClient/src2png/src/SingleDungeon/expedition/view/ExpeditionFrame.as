...
//SingleDungeon.expedition.view.ExpeditionFrame
...
package SingleDungeon.expedition.view
{
    ...
    public class ExpeditionFrame extends Frame implements IExpeditionFrame 
    {
        ...
        {
            var _local_1:String;
            var _local_2:Vector.<MapSceneModel>;
            var _local_3:MapSceneModel;
            if (ExpeditionController.instance.model.getscenceNameByID(this._expeditionInfo.SceneID))
            {
                _local_1 = ExpeditionController.instance.model.getscenceNameByID(this._expeditionInfo.SceneID);
            }
            else
            {
                _local_2 = SingleDungeonManager.Instance.mapSceneList;
                for each (_local_3 in _local_2)
                {
                    if (_local_3.ID == this._expeditionInfo.SceneID)
                    {
                        _local_1 = _local_3.Name;
                    };
                };
                ExpeditionController.instance.model.addscenceNameDic(this._expeditionInfo.SceneID, _local_1);
            };
            this._mapNameText.text = _local_1;
        }
        ...
        private function updateBtn(_arg_1:int):void
        {
            ...
            this._accelerateBtn.enable = ((((_arg_1 == START) || (_arg_1 == UPDATE)) && (this._expeditionInfo.IsOnExpedition)) ? true : false);
        ...
        {
            var _local_1:int;
            while (_local_1 < this._fightMsgVbox.numChildren)
            {
                _local_1++;
            };
        ...
        private function megChange():void
        {
            ...
            for each (_local_2 in ExpeditionController.instance.model.getItemsDic)
            {
                ...
                _local_3.times = _local_1;
                this.addVboxChild(_local_3);
                for each (_local_4 in _local_2)
                {
                    this.addVboxChild(_local_4);
                };
            };
            this.showStopMes();
            this._scrollDown.invalidateViewport(true);
        ...
        private function __start(_arg_1:MouseEvent):void
        {
            ...
            this._start = true;
            var _local_2:Array = new Array();
            _local_2["sceneID"] = this._expeditionInfo.SceneID;
            _local_2["count"] = this._infoBefore.times;
            ExpeditionController.instance.sendSocket(START, _local_2);
        }
        ...
        private function __accelerate(_arg_1:MouseEvent):void
        {
            ...
            _local_2.data = LanguageMgr.GetTranslation("singledungeon.expedition.frame.accelerateAlert", (this._expeditionInfo.AccelerateMoney * PlayerManager.Instance.Self.expeditionNumLast));
        ...
        private function __accelerateFrameResponse(_arg_1:FrameEvent):void
        {
            ...
            if (((_arg_1.responseCode == FrameEvent.ENTER_CLICK) || (_arg_1.responseCode == FrameEvent.SUBMIT_CLICK)))
            {
                ...
                else
                {
                    ...
                    _local_2 = new Array();
                    _local_2["sceneID"] = this._expeditionInfo.SceneID;
                    ExpeditionController.instance.sendSocket(ACCELERATE, _local_2);
                };
            };
