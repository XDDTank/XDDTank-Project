...
//SingleDungeon.view.WaitingGameView
...
package SingleDungeon.view
{
    ...
    public class WaitingGameView extends Component 
    {

        private const WAITING_TIME:int = 10;
        ...
        private var _currentCountDown:int = 10;
        private var _loadingIdx:int = 0;
        private var _frame:int;
        private var _fatigue:int;

        public function WaitingGameView()
        {
        ...
        protected function __onTimerComplete(_arg_1:TimerEvent):void
        {
            dispatchEvent(new SingleDungeonEvent(SingleDungeonEvent.ENTER_GAME_TIME_OUT));
        }

        protected function __onTimer(_arg_1:TimerEvent):void
        {
            this._currentCountDown--;
            this._timeText.text = this._currentCountDown.toString();
            if (PlayerManager.Instance.Self.Fatigue < this._fatigue)
            {
                this.dispose();
            };
        }
        ...
        private function initView():void
        {
            ...
            this._loadingText = ComponentFactory.Instance.creatComponentByStylename("singleDungeon.WaitingView.loadingText");
            this._loadingText.text = this._loadingArr[0];
            this._timeText = ComponentFactory.Instance.creatComponentByStylename("singleDungeon.WaitingView.timeText");
