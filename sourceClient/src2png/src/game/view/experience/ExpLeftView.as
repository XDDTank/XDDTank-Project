...
//game.view.experience.ExpLeftView
...
package game.view.experience
{
    ...
    public class ExpLeftView extends Sprite implements Disposeable 
    {
        ...
        private function init():void
        {
            ...
            this._glowFilter = new GlowFilter(0xFF9900, 1, 3, 3, 1);
            ...
            var _local_2:int;
            while (_local_2 < this._playersList.length)
            {
                this._itemList.push(new ExpFriendItem(this._playersList[_local_2]));
                PositionUtils.setPos(this._itemList[_local_2], ("experience.FriendItemPos_" + String((_local_2 + 1))));
                addChild(this._itemList[_local_2]);
                _local_2++;
            };
            this.initEffect();
        }
        ...
        public function dispose():void
        {
            ...
            {
                this._itemList[_local_1].dispose();
                this._itemList[_local_1] = null;
                _local_1++;
            };
