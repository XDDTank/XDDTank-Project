...
package game.view.tool
{
    ...
    public class DanderStrip extends Sprite implements Disposeable 
    {
        ...
        public function DanderStrip()
        {
            ...
            var _local_1:Bitmap = ComponentFactory.Instance.creatBitmap("asset.game.danderStripAsset");
            addChild(this._danderStripCopy);
            this._danderStripCopy.addChild(_local_1);
            ...
            this._skillBtn.graphics.beginFill(0xFFFFFF, 1);
            ...
            _local_2.Name = LanguageMgr.GetTranslation("tank.game.ToolStripView.itemTemplateInfo.Name");
            _local_2.Description = LanguageMgr.GetTranslation("tank.game.ToolStripView.itemTemplateInfo.Description");
            var _local_3:ToolPropInfo = new ToolPropInfo();
            _local_3.info = _local_2;
            _local_3.showTurn = false;
            _local_3.showThew = false;
            _local_3.showCount = false;
            this._btn.tipData = _local_3;
            this._btn2.tipStyle = "core.ToolPropTips";
            this._btn2.tipDirctions = "0";
            this._btn2.tipGapV = 5;
            _local_2 = new ItemTemplateInfo();
            _local_2.Name = LanguageMgr.GetTranslation("tank.game.ToolStripView.itemTemplateInfo.Name2");
            _local_2.Description = LanguageMgr.GetTranslation("tank.game.ToolStripView.itemTemplateInfo.Description2");
            _local_3 = new ToolPropInfo();
            _local_3.info = _local_2;
            _local_3.showTurn = false;
            _local_3.showThew = false;
            _local_3.showCount = false;
            this._btn2.tipData = _local_3;
            this.setDander();
            this.initEvents();
        }
        ...
        public function setInfo(_arg_1:LocalPlayer):void
        {
            this._info = _arg_1;
        }
        ...
        private function __showDanderStripTip(_arg_1:MouseEvent):void
        {
        ...
        private function __hideDanderStripTip(_arg_1:MouseEvent):void
        {
            this._danderStripTip.visible = false;
        }
        ...
        private function setDander():void
        {
            ...
            this._danderStripTip.tipData = this._danderStripTipInfo;
            var _local_1:Number = (this._info.dander / Player.TOTAL_DANDER);
            TweenLite.killTweensOf(this._mask, true);
            if (_local_1 > 0)
            {
                TweenLite.to(this._mask, 1, {"scaleX":_local_1});
            }
            else
            {
                this._mask.scaleX = 0;
        ...
        private function __updateBtn(_arg_1:LivingEvent):void
        {
        ...
        private function __useSkill(_arg_1:MouseEvent):void
        {
        ...
        private function __useSkill2(_arg_1:MouseEvent):void
        {
            GameManager.Instance.Current.selfGamePlayer.isSpecialSkill = true;
        ...
        private function __keydown(_arg_1:KeyboardEvent):void
        {
            ...
            {
                if (_arg_1.keyCode == KeyStroke.VK_N.getCode())
                {
