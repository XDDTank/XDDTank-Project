...
//game.view.smallMap.SmallMapPlayer
...
package game.view.smallMap
{
    ...
    public class SmallMapPlayer extends Sprite 
    {
        ...
        public function SmallMapPlayer(_arg_1:Living)
        {
            this._info = _arg_1;
            this.initView();
            this.initEvent();
        ...
        private function createPlayer(_arg_1:MovieClip):void
        {
            this._player = _arg_1;
            this._player.scaleX = (this._player.scaleY = 1.2);
            _arg_1["attrack_mc"].visible = false;
            addChild(this._player);
            if (this._info.isSelf)
            {
                _arg_1["player_mc"].gotoAndPlay(1);
            }
            else
            {
                _arg_1["player_mc"].gotoAndStop(8);
            };
        }
        ...
        private function __hide(_arg_1:LivingEvent):void
        {
