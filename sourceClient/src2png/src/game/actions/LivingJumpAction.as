...
package game.actions
{
    ...
    public class LivingJumpAction extends BaseAction 
    {
        ...
        public function LivingJumpAction(_arg_1:GameLiving, _arg_2:Point, _arg_3:int, _arg_4:int=0)
        {
            this._living = _arg_1;
            this._target = _arg_2;
            this._speed = _arg_3;
            this._jumpType = _arg_4;
            super();
        }

        override public function connect(_arg_1:BaseAction):Boolean
        {
            var _local_2:LivingJumpAction = (_arg_1 as LivingJumpAction);
        ...
        private function __checkMoveMovie(_arg_1:Event):void
        {
            if (this._living.actionMovie.getChildAt(0))
            {
                ...
                if (((this._moveMovie) && (this._moveMovie.totalFrames >= 4)))
                {
        ...
        private function jumpAmortize():void
        {
            if (this._state > 4)
            {
                ...
                {
                    if (((this._moveMovie) && (this._moveMovie.totalFrames >= 6)))
                    {
            ...
            {
                if ((this._living.info.pos.y - this._target.y) < -(this._speed * 2))
                {
                    this._state = (this._state + 1);
                    this._times = 0;
                    if (((this._moveMovie) && (this._moveMovie.totalFrames >= 5)))
                    {
        ...
        private function setPoint(_arg_1:Number):void
        {
            ...
            this._living.map.animateSet.addAnimation(new PhysicalObjFocusAnimation(this._living, 25, -150, AnimationLevel.MIDDLE, this._living.info.LivingID));
        }
