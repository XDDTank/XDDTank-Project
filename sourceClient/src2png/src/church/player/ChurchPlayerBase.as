...
//church.player.ChurchPlayerBase
...
package church.player
{
    ...
    public class ChurchPlayerBase extends SceneCharacterPlayerBase 
    {
        ...
        public function ChurchPlayerBase(_arg_1:PlayerInfo, _arg_2:Function=null)
        {
            super(_arg_2);
        ...
        private function sceneCharacterLoadBodyNatural():void
        {
            ...
            this._sceneCharacterLoaderBody = new SceneCharacterLoaderBody(this._playerInfo, _local_1);
            this._sceneCharacterLoaderBody.load(this.sceneCharacterLoaderBodyNaturalCallBack);
        }

        private function sceneCharacterLoaderBodyNaturalCallBack(_arg_1:SceneCharacterLoaderBody, _arg_2:Boolean=true):void
        {
