...
package church.player
{
    ...
    public class ChurchPlayer extends ChurchPlayerBase 
    {
        ...
        public function ChurchPlayer(_arg_1:PlayerVO, _arg_2:Function=null)
        {
        ...
        private function initialize():void
        {
            ...
            if (this._isShowName)
            {
                ...
                {
                    if (this.playerVO.playerInfo.ID == ChurchManager.instance.currentRoom.groomID)
                    {
        ...
        private function __onplayerPosChangeImp(_arg_1:ChurchScenePlayerEvent):void
        {
