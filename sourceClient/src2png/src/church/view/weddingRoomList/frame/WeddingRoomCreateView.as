...
//church.view.weddingRoomList.frame.WeddingRoomCreateView
...
package church.view.weddingRoomList.frame
{
    ...
    public class WeddingRoomCreateView extends BaseAlerFrame 
    {
        ...
        private var _createRoomMoney:Array = [2000, 2700, 3400];
        ...
        public function setController(_arg_1:ChurchRoomListController, _arg_2:ChurchRoomListModel):void
        {
        ...
        private function setView():void
        {
            ...
            {
                _local_1 = PlayerManager.Instance.Self.NickName;
                _local_2 = PlayerManager.Instance.Self.SpouseName;
            }
            else
            {
                _local_1 = PlayerManager.Instance.Self.SpouseName;
                _local_2 = PlayerManager.Instance.Self.NickName;
            };
            this._txtRoomCreateIntro = ComponentFactory.Instance.creat("church.view.weddingRoomList.frame.WeddingRoomCreateViewField");
            this._txtRoomCreateIntro.text = LanguageMgr.GetTranslation("church.weddingRoom.frame.CreateRoomFrame._remark_txt", _local_1, _local_2);
        ...
        private function onIsGuest(_arg_1:MouseEvent):void
        {
            SoundManager.instance.play("008");
        }

        private function onIsGuest1(_arg_1:MouseEvent):void
        {
            SoundManager.instance.play("008");
            this._roomCreateTime1SelectedBtn.filters = ComponentFactory.Instance.creatFilters("lightFilter");
            this._roomCreateTime2SelectedBtn.filters = ComponentFactory.Instance.creatFilters("grayFilter");
        ...
        private function onIsGuest2(_arg_1:MouseEvent):void
        {
            SoundManager.instance.play("008");
        ...
        private function onIsGuest3(_arg_1:MouseEvent):void
        {
            SoundManager.instance.play("008");
            this._roomCreateTime1SelectedBtn.filters = ComponentFactory.Instance.creatFilters("grayFilter");
            this._roomCreateTime2SelectedBtn.filters = ComponentFactory.Instance.creatFilters("grayFilter");
        ...
        private function createRoomConfirm():void
        {
            ...
            var _local_1:ChurchRoomInfo = new ChurchRoomInfo();
            _local_1.roomName = this._txtCreateRoomName.text;
            _local_1.password = this._txtCreateRoomPassword.text;
            _local_1.valideTimes = (this._roomCreateTimeGroup.selectIndex + 2);
            _local_1.canInvite = this._chkCreateRoomIsGuest.selected;
            _local_1.discription = FilterWordManager.filterWrod(this._txtRoomCreateIntro.text);
            this._controller.createRoom(_local_1);
            this.dispose();
        }
        ...
        private function onIntroChange(_arg_1:Event):void
        {
            this._roomCreateIntroMaxChLabel.text = ((LanguageMgr.GetTranslation("church.churchScene.frame.ModifyDiscriptionFrame.spare") + String((this._txtRoomCreateIntro.maxChars - this._txtRoomCreateIntro.text.length))) + LanguageMgr.GetTranslation("church.churchScene.frame.ModifyDiscriptionFrame.word"));
        }
