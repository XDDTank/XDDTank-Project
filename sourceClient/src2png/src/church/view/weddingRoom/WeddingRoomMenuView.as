...
//church.view.weddingRoom.WeddingRoomMenuView
...
package church.view.weddingRoom
{
    ...
    public class WeddingRoomMenuView extends Sprite implements Disposeable 
    {
        ...
        public function WeddingRoomMenuView(_arg_1:ChurchRoomModel)
        {
            this._model = _arg_1;
            this.initialize();
        }
        ...
        private function onMenuClick(_arg_1:MouseEvent):void
        {
        ...
        private function enterMoonScene(_arg_1:MouseEvent):void
        {
            SoundManager.instance.play("008");
