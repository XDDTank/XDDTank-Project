...
//church.view.weddingRoom.WeddingRoomMask
...
package church.view.weddingRoom
{
    ...
    public class WeddingRoomMask extends Sprite 
    {
        ...
        public function WeddingRoomMask(_arg_1:ChurchRoomController)
        {
        ...
        private function __timerAlarm(_arg_1:TimerEvent):void
        {
            this._totalTimes--;
        ...
        private function showAlarm(_arg_1:uint):void
        {
            this._chatMsg = new ChatData();
            this._chatMsg.channel = ChatInputView.SYS_NOTICE;
            this._chatMsg.msg = (LanguageMgr.GetTranslation("church.churchScene.SceneMask.chatMsg.msg") + _arg_1);
        ...
        private function __switchComplete(_arg_1:Event):void
        {
