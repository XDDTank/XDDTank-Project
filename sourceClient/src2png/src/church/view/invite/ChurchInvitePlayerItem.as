...
//church.view.invite.ChurchInvitePlayerItem
...
package church.view.invite
{
    ...
    public class ChurchInvitePlayerItem extends Sprite implements Disposeable, IListCell 
    {
        ...
        private function __mouseClick(_arg_1:MouseEvent):void
        {
            ...
            var _local_2:ChurchRoomInfo = ChurchManager.instance.currentRoom;
        ...
        public function set isInvite(_arg_1:Boolean):void
        {
            this._isInvite = _arg_1;
            if (this._playerInfo.invited)
            {
