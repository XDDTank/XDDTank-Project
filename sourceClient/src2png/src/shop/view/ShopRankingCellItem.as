...
package shop.view
{
    ...
    public class ShopRankingCellItem extends Sprite implements ISelectable, Disposeable 
    {
        ...
        private function initContent():void
        {
            ...
            this._itemCell = (CellFactory.instance.createShopItemCell(_local_1, null, true, true) as ShopItemCell);
        ...
        {
            if (((this._lightMc == _arg_1) || (!(this._shopItemInfo))))
            {
                return;
            };
