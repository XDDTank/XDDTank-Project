...
//shop.view.ShopLeftViewPropCollection
...
package shop.view
{
    ...
    public class ShopLeftViewPropCollection 
    {
        ...
        public function setup():void
        {
            ...
            var _local_1:int;
            while (_local_1 < PLAYER_MAX_EQUIP_CNT)
            {
                _local_2 = (CellFactory.instance.createShopPlayerItemCell() as ShopPlayerCell);
                PositionUtils.setPos(_local_2, ("ddtshop.PlayerCellPos_" + String(_local_1)));
                this.playerCells.push(_local_2);
                this.dressView.addChild(_local_2);
                _local_1++;
            };
        ...
        public function addChildrenTo(_arg_1:DisplayObjectContainer):void
        {
            _arg_1.addChild(this.middlePanelBg);
            _arg_1.addChild(this._btnBg);
            _arg_1.addChild(this.presentBtn);
            _arg_1.addChild(this.purchaseBtn);
            _arg_1.addChild(this.panelCartBtn);
            _arg_1.addChild(this.panelColorBtn);
            _arg_1.addChild(this.dressView);
            _arg_1.addChild(this.colorEditor);
            _arg_1.addChild(this.purchaseView);
            _arg_1.addChild(this.cartScroll);
            _arg_1.addChild(this.lastItem);
            _arg_1.addChild(this.randomBtn);
            _arg_1.addChild(this.playerNameText);
            _arg_1.addChild(this.rankingLabelText);
            _arg_1.addChild(this.rankingText);
        }

        public function disposeAllChildrenFrom(_arg_1:DisplayObjectContainer):void
        {
            ...
            ObjectUtils.disposeAllChildren(_arg_1);
            this.panelBtnGroup.dispose();
            this.panelBtnGroup = null;
            var _local_2:int;
            while (_local_2 < this.playerCells.length)
            {
                this.playerCells[_local_2] = null;
                _local_2++;
            };
            this.dressView = null;
