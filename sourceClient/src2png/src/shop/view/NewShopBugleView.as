...
package shop.view
{
    ...
    public class NewShopBugleView extends Sprite implements Disposeable 
    {
        ...
        public function NewShopBugleView(_arg_1:int)
        {
            this._type = _arg_1;
            this.init();
        ...
        protected function __onKeyDownd(_arg_1:KeyboardEvent):void
        {
            ...
            if (this._itemGroup.selectIndex != _local_2)
            {
                ...
                this._text2.text = (this.info.getItemPrice((_local_2 + 1)).moneyValue + LanguageMgr.GetTranslation("ddtMoney"));
            };
        ...
        {
            var _local_2:NewShopBugViewItem;
            SoundManager.instance.play("008");
            switch (_arg_1.responseCode)
            {
                ...
                case FrameEvent.ENTER_CLICK:
                    ...
                    _local_2 = (this._itemContainer.getChildAt(this._itemGroup.selectIndex) as NewShopBugViewItem);
        ...
        private function addItem(_arg_1:ShopItemInfo, _arg_2:int):void
        {
            ...
            var _local_5:NewShopBugViewItem = new NewShopBugViewItem(_arg_2, _arg_1.getTimeToString(_arg_2), _arg_1.getItemPrice(_arg_2).moneyValue, _local_4);
        ...
        {
            SoundManager.instance.play("008");
            this._itemGroup.selectIndex = this._itemContainer.getChildIndex((_arg_1.currentTarget as NewShopBugViewItem));
            this._text2.text = ((_arg_1.currentTarget as NewShopBugViewItem).money + LanguageMgr.GetTranslation("ddtMoney"));
        }
