...
package vip.view
{
    ...
    public class GiveOthersOpenedView extends GiveYourselfOpenView implements Disposeable 
    {
        ...
        private function init():void
        {
            ...
            this._amountOfMoney.text = String(PlayerManager.Instance.Self.Money);
            addChild(this._amountOfMoney);
            _itemScroll.visible = false;
            _vipPrivilegeTxt.visible = false;
            _spreeView.visible = false;
            showOpenOrRenewal();
            rewardBtnCanUse();
            this.addEvent();
        }
        ...
        {
            this._amountOfMoney.text = PlayerManager.Instance.Self.Money.toString();
        }
        ...
        override protected function __openVip(_arg_1:MouseEvent):void
        {
            ...
            var _local_2:String = LanguageMgr.GetTranslation("ddt.vip.vipView.confirmforOther", this._friendName.text, time, payNum);
        ...
        {
            SoundManager.instance.play("008");
            var _local_2:Point = this._friendListBtn.localToGlobal(new Point(0, 0));
