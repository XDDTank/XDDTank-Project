...
//activity.analyze.ActivityConditionAnalyzer
...
package activity.analyze
{
    ...
    public class ActivityConditionAnalyzer extends DataAnalyzer 
    {
        ...
        public function ActivityConditionAnalyzer(_arg_1:Function)
        {
            super(_arg_1);
        }
        ...
        {
            var _local_3:int;
            var _local_4:ActivityConditionInfo;
            ...
            if (this._xml.@value == "true")
            {
                ...
                {
                    _local_4 = new ActivityConditionInfo();
