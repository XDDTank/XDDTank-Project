...
package civil.view
{
    ...
    public class CivilRightView extends Sprite implements Disposeable 
    {
        ...
        public function CivilRightView(_arg_1:CivilController, _arg_2:CivilModel)
        {
            this._model = _arg_2;
        ...
        private function __onRegisterChange(_arg_1:CivilEvent):void
        {
        }
        ...
        private function __addBtnClick(_arg_1:MouseEvent):void
        {
        ...
        private function __sexBtnClick(_arg_1:MouseEvent):void
        {
            SoundManager.instance.play("008");
            this._currentPage = 1;
            if (_arg_1.currentTarget == this._femaleBtn)
            {
                this._sex = false;
        ...
        private function __leafBtnClick(_arg_1:MouseEvent):void
        {
            SoundManager.instance.play("008");
            if (this._loadMember)
            {
        ...
        private function __searchTxtClick(_arg_1:MouseEvent):void
        {
            if (this._searchTxt.text == LanguageMgr.GetTranslation("academy.view.AcademyMemberListView.searchTxt"))
            {
                this._searchTxt.text = "";
        ...
        private function __memberSelectedChange(_arg_1:CivilEvent):void
        {
        }
        ...
        private function updateButton():void
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        if (((this._currentPage == this._model.TotalPage) && (!(this._currentPage == 0))))
                        {
        ...
        private function __updateRegisterGlow(_arg_1:CivilEvent):void
        {
        }

        private function setButtonState(_arg_1:Boolean, _arg_2:Boolean):void
        {
            this._preBtn.mouseChildren = _arg_1;
            this._preBtn.enable = _arg_1;
            this._nextBtn.mouseChildren = _arg_2;
            this._nextBtn.enable = _arg_2;
        }
