...
//auctionHouse.view.BaseStripView
...
package auctionHouse.view
{
    ...
    public class BaseStripView extends Sprite implements Disposeable 
    {
        ...
        protected function initView():void
        {
            ...
            this.leftBG = ComponentFactory.Instance.creatBitmap("auctionHouse.StripGoodsRightBG");
            addChild(this.leftBG);
            this.stripSelect_bit = ComponentFactory.Instance.creatBitmap("asset.ddtauction.ListPos1");
        ...
        internal function set info(_arg_1:AuctionGoodsInfo):void
        {
            this._info = _arg_1;
            this.update();
            this.updateInfo();
        ...
        internal function set isSelect(_arg_1:Boolean):void
        {
        ...
        protected function updateInfo():void
        {
            ...
            this.leftBG.visible = (((this._info.index % 2) == 0) ? true : false);
            mouseEnabled = true;
            buttonMode = true;
            this.addEvent();
        }
