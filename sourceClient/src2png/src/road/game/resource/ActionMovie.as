...
//road.game.resource.ActionMovie
...
package road.game.resource
{
    ...
    public class ActionMovie extends MovieClip 
    {
        ...
        public var labelMapping:Dictionary = new Dictionary();
        ...
        {
            var _local_4:String;
            if (((this.labelMapping) && (this.labelMapping[_arg_1])))
            {
        ...
        {
            if ((((this._labelLastFrame) && (currentFrame == this._labelLastFrame[this.currentAction])) || (!(currentLabel == this.currentAction))))
            {
        ...
        private function __onActionEnd(_arg_1:ActionMovieEvent):void
        {
            ...
            {
                var _local_2:* = this._actionRelative;
        ...
        public function dispose():void
        {
            ...
            removeEventListener(Event.ENTER_FRAME, this.loop);
            removeEventListener(ActionMovieEvent.ACTION_END, this.__onActionEnd);
            this.stopMovieClip(this);
            stop();
            this._soundControl = null;
            this._labelLastFrame = null;
            this._callBacks = null;
            this._argsDic = null;
            this._actionRelative = null;
            this.labelMapping = null;
            this._soundEffectInstance = null;
            if (parent)
            {
