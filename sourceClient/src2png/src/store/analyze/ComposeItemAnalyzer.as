...
//store.analyze.ComposeItemAnalyzer
...
package store.analyze
{
    ...
    public class ComposeItemAnalyzer extends DataAnalyzer 
    {

        public var list:DictionaryData;
        private var _xml:XML;

        public function ComposeItemAnalyzer(_arg_1:Function)
        {
            super(_arg_1);
        }
