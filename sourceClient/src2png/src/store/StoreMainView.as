...
package store
{
    ...
    public class StoreMainView extends Sprite implements Disposeable 
    {
        ...
        protected function __groupChangeHandler(_arg_1:Event):void
        {
            this._tabSelectedButtonContainer.arrange();
        }
        ...
        private function __updateStoreBag(_arg_1:BagEvent):void
        {
            this.currentPanel.refreshData(_arg_1.changedSlots);
        }

        public function set currentPanelIndex(_arg_1:int):void
        {
            NewHandContainer.Instance.clearArrowByID(ArrowType.STRENG_CHOOSE_WEAPON);
            NewHandContainer.Instance.clearArrowByID(ArrowType.TRANSFER_CHOOSE_WEAPON);
            this._currentPanelIndex = _arg_1;
        ...
        private function __composeClick(_arg_1:MouseEvent):void
        {
        ...
        private function __splitClick(_arg_1:MouseEvent):void
        {
        ...
        private function __lianhuaClick(_arg_1:MouseEvent):void
        {
        }

        private function __embedBtnClick(_arg_1:MouseEvent):void
        {
        ...
        private function __transferClick(_arg_1:MouseEvent):void
        {
        ...
        private function __refiningClick(_arg_1:MouseEvent):void
        {
        ...
        private function changeToTab(_arg_1:int, _arg_2:Boolean=true):void
        {
        ...
        public function changeTabByIndex(_arg_1:int):void
        {
            var _local_2:MouseEvent = new MouseEvent(MouseEvent.CLICK);
            switch (_arg_1)
            {
                case STRENGTH:
                    this.__strengthClick(_local_2);
                    break;
                case COMPOSE:
                    this.__composeClick(_local_2);
                    break;
                case TRANSF:
                    this.__transferClick(_local_2);
                    break;
                case EMBED:
                    this.__embedBtnClick(_local_2);
                    break;
                case REFINING:
                    this.__refiningClick(_local_2);
                    break;
            };
            this._tabSelectedButtonGroup.selectIndex = _arg_1;
        }
