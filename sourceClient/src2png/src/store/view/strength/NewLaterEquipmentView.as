...
//store.view.strength.NewLaterEquipmentView
...
package store.view.strength
{
    ...
    public class NewLaterEquipmentView extends Component 
    {
        ...
        override protected function init():void
        {
            ...
            {
                this._refiningTxtVec[_local_2] = ComponentFactory.Instance.creatComponentByStylename("EquipsTipPanel.refiningTxt");
                _local_2++;
            };
            ...
            {
                this._embedVec[_local_3] = new EquipTipEmbedItem(_local_3);
                _local_3++;
            };
            ...
            while (_local_4 < 6)
            {
                this._propVec[_local_4] = ComponentFactory.Instance.creatComponentByStylename("EquipsTipPanel.basePropTitle");
                _local_4++;
            };
        ...
        override public function set tipData(_arg_1:Object):void
        {
            ...
            if (_arg_1)
            {
                ...
                {
                    _tipData = (_arg_1 as ItemTemplateInfo);
                    _local_2 = (_arg_1 as InventoryItemInfo);
                    _local_3 = ItemManager.Instance.getEquipTemplateById(_local_2.TemplateID);
                    if (((_local_2) && (_local_3)))
                    {
                        if (_local_2.StrengthenLevel == _local_3.StrengthLimit)
                        {
                            this.visible = false;
                        }
                        else
        ...
        public function showTip(_arg_1:Object):void
        {
        ...
        private function showHeadPart():void
        {
            ...
            {
                this._equipName.text = ((this._info.Name + "+") + String((_local_1.StrengthenLevel + 1)));
            };
            if (ItemManager.Instance.judgeJewelry(this._info))
            {
                if (_local_1)
                {
                    _local_3 = StoreController.instance.Model.getRefiningConfigByLevel((_local_1.StrengthenLevel + 1));
                    if (_local_3)
                    {
        ...
        private function showMiddlePart():void
        {
            ...
            if ((((ItemManager.Instance.judgeJewelry(this._info)) || (_local_1 == null)) || ((_local_1.StrengthenLevel + 1) == 0)))
            {
                _local_5 = 0;
                _local_6 = 0;
            }
            ...
            {
                _local_5 = ItemManager.Instance.getAddMinorProperty(this._info, _local_1);
                _local_6 = ItemManager.Instance.getAddTwoMinorProperty(this._info, _local_1);
            };
        ...
        private function showRefiningPart():void
        {
            ...
            var _local_3:RefiningConfigInfo;
            var _local_4:int;
            var _local_5:RefiningConfigInfo;
            var _local_6:int;
            ...
            if (ItemManager.Instance.judgeJewelry(this._info))
            {
                if ((this._info is InventoryItemInfo))
                {
                    ...
                    _local_3 = StoreController.instance.Model.getRefiningConfigByLevel((_local_2.StrengthenLevel + 1));
                    if (((!(_local_3)) || (_local_3.Level == 0)))
                    {
                    ...
                    else
                    {
                        ...
                        _local_4 = 0;
                        while (_local_4 < this._refiningTxtVec.length)
                        {
                            this._refiningTxtVec[_local_4].visible = true;
                            _local_4++;
                        };
                        this._refiningTitleTxt.text = LanguageMgr.GetTranslation("ddt.EquipTipPanel.refiningTitle1");
                        this._refiningTitleTxt.y = this._thisHeight;
                        this._thisHeight = (this._thisHeight + this._refiningTitleTxt.height);
                        _local_5 = StoreController.instance.Model.getRefiningConfigByLevel(this._EquipInfo.StrengthLimit);
                        this._refiningTitleDec.text = LanguageMgr.GetTranslation("ddt.EquipTipPanel.refiningTitleDic", _local_5.Desc);
        ...
        private function showButtomPart():void
        {
            ...
            var _local_4:RefiningConfigInfo = StoreController.instance.Model.getRefiningConfigByLevel((_local_3.StrengthenLevel + 1));
