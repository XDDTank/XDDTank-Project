...
//consortion.ConsortiaTaskLevelTip
...
package consortion
{
    ...
    public class ConsortiaTaskLevelTip extends BaseTip 
    {
        ...
        override public function set tipData(_arg_1:Object):void
        {
            ...
            this._contributionText2.text = ((_arg_1[0] == null) ? "" : _arg_1[0]);
            ...
            this._bankrollText2.htmlText = ((_arg_1[1] == null) ? "" : _arg_1[1]);
            this._bankrollText2.x = ((this._bankrollText.x + this._bankrollText.textWidth) + 20);
            this._publishLevel = ((_arg_1[2] == null) ? 1 : int(_arg_1[2]));
            if (PlayerManager.Instance.Self.consortiaInfo.Level < this._publishLevel)
            {
                ...
                this._openLevelText.text = LanguageMgr.GetTranslation("consortion.ConsortionTask.taskOpenLevel.text", ((_arg_1[2] == null) ? "" : _arg_1[2]));
