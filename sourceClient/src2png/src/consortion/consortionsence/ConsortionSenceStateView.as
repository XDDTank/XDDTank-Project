...
//consortion.consortionsence.ConsortionSenceStateView
...
package consortion.consortionsence
{
    ...
    public class ConsortionSenceStateView extends BaseStateView 
    {

        private static var _instance:ConsortionSenceStateView;

        private var _view:ConsortionSenceWalkMapView;


        public static function get Instance():ConsortionSenceStateView
        {
            if ((!(_instance)))
            {
                _instance = new (ConsortionSenceStateView)();
            };
            return (_instance);
        }
        ...
        {
            this._view = new ConsortionSenceWalkMapView(this, ConsortionModel.CONSORTION_SENCE);
            this._view.show();
        }
        ...
        private function __addPlayer(_arg_1:CrazyTankSocketEvent):void
        {
            ...
            ConsortionManager.Instance._consortionWalkMode.addPlayer(_local_6);
        }
