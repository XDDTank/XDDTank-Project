...
//consortion.consortionsence.ConsortionWalkPlayerInfo
...
package consortion.consortionsence
{
    ...
    public class ConsortionWalkPlayerInfo extends EventDispatcher 
    {
        ...
        public var currenWalkStartPoint:Point;
        ...
        public function clone():ConsortionWalkPlayerInfo
        {
            var _local_1:ConsortionWalkPlayerInfo = new ConsortionWalkPlayerInfo();
