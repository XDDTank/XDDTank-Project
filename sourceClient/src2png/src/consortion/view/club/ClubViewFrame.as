...
//consortion.view.club.ClubViewFrame
...
package consortion.view.club
{
    ...
    public class ClubViewFrame extends Frame 
    {
        ...
        private function initView():void
        {
            ...
            var _local_1:Rectangle = ComponentFactory.Instance.creatCustomObject("asset.ddtconsortion.ClublistTopBgRect");
            this._listTopBg.x = _local_1.x;
            this._listTopBg.y = _local_1.y;
        ...
        private function __applySelect(_arg_1:MouseEvent):void
        {
        ...
        private function __createConsortionHandler(_arg_1:MouseEvent):void
        {
            SoundManager.instance.play("008");
            ...
            var _local_2:CreateConsortionFrame = ComponentFactory.Instance.creatComponentByStylename("createConsortionFrame");
        ...
        private function __consrotionListComplete(_arg_1:ConsortionEvent):void
        {
