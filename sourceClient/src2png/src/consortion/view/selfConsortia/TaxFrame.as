...
//consortion.view.selfConsortia.TaxFrame
...
package consortion.view.selfConsortia
{
    ...
    public class TaxFrame extends Frame 
    {
        ...
        private function __responseHanlder(_arg_1:FrameEvent):void
        {
        ...
        private function __confirmHanlder(_arg_1:MouseEvent):void
        {
            ...
            var _local_2:int = int(this._taxMoney.text);
            if (((_local_2 > PlayerManager.Instance.Self.Money) || (PlayerManager.Instance.Self.Money == 0)))
            {
            ...
            {
                if (Number(this._taxMoney.text) < 1)
                {
                    this._taxMoney.text = "";
                    this._confirm.enable = false;
        ...
        private function __alertResponse(_arg_1:FrameEvent):void
        {
            ...
            {
                if (_local_2 == this.leaveToFillAlert)
                {
                    LeavePageManager.leaveToFillPath();
                }
                else
                {
                    if (_local_2 == this.confirmAlert)
                    {
                        this.sendSocketData();
                    };
                };
        ...
        private function sendSocketData():void
        {
            ...
            {
                _local_1 = int(this._taxMoney.text);
                SocketManager.Instance.out.sendConsortiaRichOffer(_local_1);
                this.dispose();
            };
        }
        ...
        private function __taxChangeHandler(_arg_1:Event):void
        {
            ...
            var _local_2:int = int(this._taxMoney.text);
            if (_local_2 >= PlayerManager.Instance.Self.Money)
            {
