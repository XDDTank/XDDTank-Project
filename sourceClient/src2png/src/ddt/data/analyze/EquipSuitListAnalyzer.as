...
//ddt.data.analyze.EquipSuitListAnalyzer
...
package ddt.data.analyze
{
    ...
    public class EquipSuitListAnalyzer extends DataAnalyzer 
    {
        ...
        public function EquipSuitListAnalyzer(_arg_1:Function)
        {
            super(_arg_1);
        }
        ...
        override public function analyze(_arg_1:*):void
        {
            ...
            if (_local_2.@value == "true")
            {
                ...
                {
                    _local_5 = new EquipSuitInfo();
                    ObjectUtils.copyPorpertiesByXML(_local_5, _local_3[_local_4]);
                    this._list.add(_local_5.SuitID, _local_5);
                    _local_4++;
                };
                onAnalyzeComplete();
            }
