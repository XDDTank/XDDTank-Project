...
//ddt.data.analyze.BagCellInfoListAnalyze
...
package ddt.data.analyze
{
    ...
    public class BagCellInfoListAnalyze extends DataAnalyzer 
    {
        ...
        public function BagCellInfoListAnalyze(_arg_1:Function)
        {
            super(_arg_1);
        }
        ...
        override public function analyze(_arg_1:*):void
        {
            ...
            if (_local_2.@value == "true")
            {
                ...
                {
                    _local_5 = new BagCellInfo();
                    ObjectUtils.copyPorpertiesByXML(_local_5, _local_3[_local_4]);
                    this._list.add(_local_5.CellID, _local_5);
                    _local_4++;
                };
                onAnalyzeComplete();
            }
