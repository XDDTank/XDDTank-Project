...
//ddt.view.tips.PetCommonSkillTip
...
package ddt.view.tips
{
    ...
    public class PetCommonSkillTip extends BaseTip 
    {
        ...
        {
            this._data = _arg_1;
            this._info = (_arg_1 as PetCommonSkill);
            if ((!(this._info)))
            {
                return;
            };
        ...
        {
            var _local_1:Dictionary = PetSkillManager.instance.getPreSkill(this._data);
            this.name_txt.text = this._info.Name;
            this._descTxt.text = ("本级:" + _local_1["c"].join(","));
            this._descTxt.text = (this._descTxt.text + ("\t  下一级:" + _local_1["n"].join(",")));
            this._descTxt.text = (this._descTxt.text + ("   是否学习:" + this.fixPos()));
