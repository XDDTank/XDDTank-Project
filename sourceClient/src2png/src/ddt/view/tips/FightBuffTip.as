...
package ddt.view.tips
{
    ...
    public class FightBuffTip extends BaseTip 
    {
        ...
        {
            var _local_2:TextFormat = this.buff_txt.getTextFormat();
            _local_2.color = _arg_1;
            this.buff_txt.setTextFormat(_local_2);
        }

        private function propertyText(_arg_1:String):void
        {
            this.buff_txt.text = _arg_1;
        }

        private function detailText(_arg_1:String):void
        {
            this.detail_txt.htmlText = _arg_1;
            this.updateWH();
        }
