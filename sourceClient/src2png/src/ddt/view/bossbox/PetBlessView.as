...
package ddt.view.bossbox
{
    ...
    public class PetBlessView extends BaseAlerFrame 
    {
        ...
        override protected function init():void
        {
            ...
            this._newNameTxt.y = (this._newNameTxt.y + 16);
            ...
            var _local_1:AlertInfo = new AlertInfo("", LanguageMgr.GetTranslation("ok"), LanguageMgr.GetTranslation("cancel"), true, true);
            _local_1.customPos = ComponentFactory.Instance.creat("asset.bagAndInfo.petBless.pos");
            info = _local_1;
        }
        ...
        protected function __onRespose(_arg_1:FrameEvent):void
        {
        ...
        protected function __onNextStep(_arg_1:Event):void
        {
            if ((!(this._blessBg)))
            {
        ...
        protected function __onAddComplete(_arg_1:Event):void
        {
        ...
        protected function __petBlessed(_arg_1:CrazyTankSocketEvent):void
        {
            this.play();
        }
        ...
        public function set petInfo(_arg_1:PetInfo):void
        {
