...
//ddt.view.character.BaseLightLayer
...
package ddt.view.character
{
    ...
    public class BaseLightLayer extends Sprite implements ILayer 
    {
        ...
        public function BaseLightLayer(_arg_1:int, _arg_2:int=0)
        {
            this._nimbus = _arg_1;
            this._type = _arg_2;
        }
        ...
        protected function __sourceComplete(_arg_1:LoaderEvent=null):void
        {
            ...
            {
                if (((!(this.getId() == "00")) && (!(this.getId() == "0"))))
                {
                    _local_2 = (ClassUtils.uiSourceDomain.getDefinition(("game.crazyTank.view.light.CircleLightAsset_" + this.getId())) as Class);
