...
package ddt.command
{
    ...
    public class ShineObject extends Sprite 
    {
        ...
        public function ShineObject(_arg_1:MovieClip, _arg_2:Boolean=true)
        {
            this._shiner = _arg_1;
            this._addToBottom = _arg_2;
            super();
            this.init();
            this.initEvents();
        }
        ...
        public function shine(_arg_1:Boolean=false):void
        {
            if (this._shiner)
            {
                if (((!(SoundManager.instance.isPlaying("044"))) && (_arg_1)))
                {
        ...
        public function get addToBottom():Boolean
        {
            return (this._addToBottom);
        }

        public function set addToBottom(_arg_1:Boolean):void
        {
            this._addToBottom = _arg_1;
        }
