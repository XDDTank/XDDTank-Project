...
//com.pickgliss.ui.image.ScaleUpDownImage
...
package com.pickgliss.ui.image
{
    ...
    public class ScaleUpDownImage extends Image 
    {
        ...
        private function drawImage():void
        {
            ...
            graphics.drawRect(0, this._bitmaps[0].height, this._bitmaps[0].width, ((_height - this._bitmaps[0].height) - this._bitmaps[2].height));
            graphics.endFill();
