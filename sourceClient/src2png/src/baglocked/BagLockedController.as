...
package baglocked
{
    ...
    public class BagLockedController extends EventDispatcher 
    {
        ...
        public function set bagLockedInfo(_arg_1:BagLockedInfo):void
        {
            this._bagLockedInfo = _arg_1;
        }
        ...
        private function loadUi(_arg_1:Function):void
        {
            this._currentFn = _arg_1;
        ...
        private function __uiProgress(_arg_1:UIModuleEvent):void
        {
            if (_arg_1.module == UIModuleTypes.DDT_BAGLOCKER)
            {
                UIModuleSmallLoading.Instance.progress = (_arg_1.loader.progress * 100);
            };
        }

        private function __uiComplete(_arg_1:UIModuleEvent):void
        {
            if (_arg_1.module == UIModuleTypes.DDT_BAGLOCKER)
            {
                UIModuleSmallLoading.Instance.removeEventListener(Event.CLOSE, this.__onClose);
                UIModuleLoader.Instance.removeEventListener(UIModuleEvent.UI_MODULE_PROGRESS, this.__uiProgress);
                _arg_1.currentTarget.removeEventListener(UIModuleEvent.UI_MODULE_COMPLETE, this.__uiComplete);
                UIModuleSmallLoading.Instance.hide();
