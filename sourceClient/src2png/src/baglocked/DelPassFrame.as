...
package baglocked
{
    ...
    public class DelPassFrame extends Frame 
    {
        ...
        private function __delBtnClick(_arg_1:MouseEvent):void
        {
            ...
            var _local_2:String = ((PlayerManager.Instance.Self.leftTimes <= 0) ? "0" : String(PlayerManager.Instance.Self.leftTimes));
            this._text6_7.text = LanguageMgr.GetTranslation("baglocked.DelPassFrame.operationAlertInfo", _local_2);
        ...
        private function __deselectBtn6Click(_arg_1:MouseEvent):void
        {
            SoundManager.instance.play("008");
            this._bagLockedController.close();
        }

        private function __delPasswordHandler(_arg_1:BagEvent):void
        {
            this._bagLockedController.close();
        }
