...
package baglocked
{
    ...
    public class UpdatePassFrame extends Frame 
    {
        ...
        private function __deselectBtn5Click(_arg_1:MouseEvent):void
        {
        ...
        private function __updateBtnClick(_arg_1:MouseEvent):void
        {
            var _local_2:String;
            SoundManager.instance.play("008");
            if (this._textInput5_2.text == this._textInput5_3.text)
            {
                ...
                _local_2 = ((PlayerManager.Instance.Self.leftTimes <= 0) ? "0" : String(PlayerManager.Instance.Self.leftTimes));
                this._text5_5.text = LanguageMgr.GetTranslation("baglocked.DelPassFrame.operationAlertInfo", _local_2);
        ...
        private function __updateSuccessHandler(_arg_1:BagEvent):void
        {
            this._bagLockedController.closeUpdatePassFrame();
        }
