    ...
    public final class FSM_imalloc extends Machine 
    {
        ...
        public static function start():void
        {
            ...
            if (!(uint(_local_1) > uint(0x0800)))
            {
                ...
                if (uint(_local_2) < uint(2)) goto _label_17;
                _local_3 = -1;
                do 
                {
                    _local_3 = (_local_3 + 1);
            ...
            _label_2: 
                ...
                _label_7: 
                    ...
                    _label_8: 
                        ...
                        _local_5 = (_local_8 & 0x01);
                        if (_local_5 == 0) goto _label_19;
                        _local_7 = 0;
                        _local_5 = 1;
                        goto _label_11;
                    };
                ...
                _label_10: 
                    _local_7 = (_local_7 + 1);
                    _local_5 = (_local_5 << 1);
                    _local_9 = (_local_8 & _local_5);
                } while ((_local_9 == 0));
                
            _label_11: 
                _local_5 = (_local_8 ^ _local_5);
                si32(_local_5, _local_6);
                _local_5 = li16(_local_4 + 12);
                _local_5 = (_local_5 + -1);
                si16(_local_5, (_local_4 + 12));
                _local_5 = (_local_5 & 0xFFFF);
                if (!(!(_local_5 == 0)))
                {
                    _local_5 = 0;
                    _local_2 = (_local_2 << 2);
                ...
                if (!(!(_local_3 == 0)))
                {
                    ...
                    if (_local_2 == 0) goto _label_16;
                    _local_4 = (_local_3 & 0x01);
                ...
                _local_4 = li8(_malloc_zero_2E_b);
                _local_2 = (_local_3 + _local_2);
                if (_local_2 == 0) goto _label_16;
                _local_3 = (_local_4 & 0x01);
                if (!(!(_local_3 == 0))) goto _label_16;
                goto _label_12;
            };
            mstate.esp = (mstate.esp - 4);
