package login
{
   ...
   public class LoginStateView extends BaseStateView
   {
      ...
      public static function creatLoginLoader(param1:String, param2:Function) : RequestLoader
      {
         ...
         var _loc10_:RequestLoader = LoadResourceManager.instance.createLoader(PathManager.solveRequestPath("Login.ashx"),BaseLoader.REQUEST_LOADER,_loc9_);
      ...
      private static function __onLoadLoginError(param1:LoaderEvent) : void
      {
         ...
         var _loc3_:BaseAlerFrame = AlertManager.Instance.simpleAlert("警告：",_loc2_,"确认");
      ...
      {
         var _loc1_:RequestLoader = creatLoginLoader(SelectListManager.Instance.currentLoginRole.NickName,this.onLoginComplete);
      ...
      private function onLoginComplete(param1:LoginAnalyzer) : void
      {
