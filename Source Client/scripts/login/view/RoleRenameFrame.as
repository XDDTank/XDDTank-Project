package login.view
{
   ...
   public class RoleRenameFrame extends Frame
   {
      ...
      private function __onTextInputChange(param1:TextEvent) : void
      {
         var _loc2_:int = StringHelper.getStringByteLength(param1.target.text);
         if(_loc2_ >= param1.target.maxChars)
         {
      ...
      protected function createCheckLoader(param1:String, param2:Function) : BaseLoader
      {
         ...
         var _loc4_:BaseLoader = LoadResourceManager.instance.createLoader(PathManager.solveRequestPath(param1),BaseLoader.REQUEST_LOADER,_loc3_);
      ...
      {
         var _loc5_:RequestLoader = LoadResourceManager.instance.createLoader(PathManager.solveRequestPath(param1),BaseLoader.REQUEST_LOADER,param2);
      ...
      protected function doRename() : void
      {
         ...
         LoadResourceManager.instance.startLoad(_loc8_);
      }
