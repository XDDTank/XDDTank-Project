package feedback
{
   ...
   public class FeedbackManager extends EventDispatcher
   {
      ...
      public function setupFeedbackData(param1:LoadFeedbackReplyAnalyzer) : void
      {
         ...
         var _loc3_:BaseLoader = LoadResourceManager.instance.createLoader(PathManager.solveRequestPath("AdvanceQuestTime.ashx"),BaseLoader.REQUEST_LOADER,_loc2_);
      ...
      public function submitFeedbackInfo(param1:FeedbackInfo) : void
      {
         ...
         var _loc3_:BaseLoader = LoadResourceManager.instance.createLoader(PathManager.solveRequestPath("AdvanceQuestion.ashx"),BaseLoader.REQUEST_LOADER,_loc2_,URLRequestMethod.POST);
      ...
      public function continueSubmit(param1:String, param2:String, param3:int, param4:String) : void
      {
         this._removeFeedbackInfoId = param2 + "_" + param3;
         ...
         _loc5_.question_id = param2;
         _loc5_.reply_id = param3;
         _loc5_.reply_content = param4;
         _loc5_.title = param1;
         var _loc6_:BaseLoader = LoadResourceManager.instance.createLoader(PathManager.solveRequestPath("AdvanceReply.ashx"),BaseLoader.REQUEST_LOADER,_loc5_,URLRequestMethod.POST);
      ...
      public function delPosts(param1:String, param2:int, param3:int, param4:String) : void
      {
         ...
         var _loc6_:BaseLoader = LoadResourceManager.instance.createLoader(PathManager.solveRequestPath("AdvanceQuestionAppraisal.ashx"),BaseLoader.REQUEST_LOADER,_loc5_,URLRequestMethod.POST);
         _loc6_.addEventListener(LoaderEvent.COMPLETE,this.__onLoadFreeBackComplete);
         LoadResourceManager.instance.startLoad(_loc6_);
         this.closeFrame();
      }
