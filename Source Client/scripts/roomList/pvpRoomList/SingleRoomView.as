package roomList.pvpRoomList
{
   ...
   public class SingleRoomView extends Frame
   {
      ...
      public function initII(param1:RoomInfo) : void
      {
      ...
      {
         var _loc2_:uint = 9 - this._timer.currentCount % 10;
         this._timeTxt.text = "0" + _loc2_;
      ...
      protected function __startHandler(param1:RoomEvent) : void
      {
         ...
         else
         {
            ...
            else if(this._info.selfRoomPlayer.isReady)
            {
               MainToolBar.Instance.setRoomStartState();
            }
            else
