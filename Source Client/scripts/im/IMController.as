package im
{
   ...
   public class IMController extends EventDispatcher
   {
      ...
      private function __onResponse(param1:FrameEvent) : void
      {
         ...
         if(param1.responseCode == FrameEvent.ESC_CLICK)
         {
      ...
      public function createConsortiaLoader() : void
      {
         ...
         if(!StringHelper.isNullOrEmpty(PathManager.CommunityFriendList()))
         {
            ...
            _loc2_ = LoadResourceManager.instance.createLoader(PathManager.CommunityFriendList(),BaseLoader.REQUEST_LOADER,_loc1_);
      ...
      public function loadRecentContacts() : void
      {
         ...
         var _loc2_:BaseLoader = LoadResourceManager.instance.createLoader(PathManager.solveRequestPath("IMRecentContactsList.ashx"),BaseLoader.REQUEST_LOADER,_loc1_);
