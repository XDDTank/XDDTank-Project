package changeColor.view
{
   ...
   public class ChangeColorLeftView extends Sprite implements Disposeable
   {
      ...
      {
         this._model.self.setPartStyle(this._model.currentItem,!!this._model.self.Sex ? int(1) : int(2),PlayerManager.Instance.Self.getPartStyle(this._model.currentItem.CategoryID),PlayerManager.Instance.Self.getPartColor(this._model.currentItem.CategoryID),true);
