package cityWide
{
   ...
   public class CityWideManager
   {
      ...
      public function showCityWide(param1:Function, param2:String) : void
      {
      ...
      private function __cityWityComplete(param1:UIModuleEvent) : void
      {
         UIModuleSmallLoading.Instance.hide();
         UIModuleSmallLoading.Instance.removeEventListener(Event.CLOSE,this.__onClose);
         UIModuleLoader.Instance.removeEventListener(UIModuleEvent.UI_MODULE_COMPLETE,this.__cityWityComplete);
      ...
      private function __cityWityProgress(param1:UIModuleEvent) : void
      {
