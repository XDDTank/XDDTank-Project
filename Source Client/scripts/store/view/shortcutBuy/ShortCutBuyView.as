package store.view.shortcutBuy
{
   ...
   public class ShortCutBuyView extends Sprite implements Disposeable
   {
      ...
      private function init() : void
      {
         ...
         if(_loc1_ && _loc1_.getItemPrice(1).IsDDTMoneyType && this._templateItemIDList.indexOf(_loc1_.TemplateID) > -1)
         {
      ...
      public function get totalPrice() : ItemPrice
      {
         ...
         {
            _loc1_ = this.currentShopItem.getItemPrice(1).multiply(this._num.currentValue);
         }
         return _loc1_;
      }
