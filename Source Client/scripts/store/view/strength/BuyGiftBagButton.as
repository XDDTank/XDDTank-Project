   ...
   public class BuyGiftBagButton extends BuyItemButton
   {
      ...
      override protected function __onMouseClick(param1:MouseEvent) : void
      {
         ...
         if(_enable)
         {
            ...
            _loc2_ = AlertManager.Instance.simpleAlert(LanguageMgr.GetTranslation("AlertDialog.Info"),LanguageMgr.GetTranslation("store.view.strength.buyGift"),LanguageMgr.GetTranslation("ok"),LanguageMgr.GetTranslation("cancel"),false,true,false,LayerManager.ALPHA_BLOCKGOUND);
