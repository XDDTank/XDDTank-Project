package store.view.strength
{
   ...
   public class StrengthTips extends BaseTip implements ITip, Disposeable
   {
      ...
      private function showMiddlePart() : void
      {
         ...
         {
            _loc2_.push(LanguageMgr.GetTranslation("ddt.EquipTipPanel.PropArr",_loc3_.PropertyName,this._EquipInfo.MainProperty1Value,_loc1_.StrengthenLevel > 0 ? (_loc5_ != 0 ? "(+" + _loc5_ + ")" : "") : ""));
         }
         if(this._EquipInfo.MainProperty2ID != 0)
         {
            _loc2_.push(LanguageMgr.GetTranslation("ddt.EquipTipPanel.PropArr",_loc4_.PropertyName,this._EquipInfo.MainProperty2Value,_loc1_.StrengthenLevel > 0 ? (_loc6_ != 0 ? "(+" + _loc6_ + ")" : "") : ""));
         }
         var _loc7_:int = 0;
         while(_loc7_ < 2)
         {
      ...
      private function showButtomPart() : void
      {
         ...
         var _loc4_:RefiningConfigInfo = StoreController.instance.Model.getRefiningConfigByLevel(_loc3_.StrengthenLevel);
