package worldboss
{
   ...
   public class WorldBossManager extends EventDispatcher
   {
      ...
      public function buyNewBuff() : void
      {
         ...
         if(PlayerManager.Instance.Self.totalMoney < _loc1_)
         {
      ...
      public function showWorldBossAward(param1:Function, param2:String) : void
      {
      ...
      private function __worldBossAwardComplete(param1:UIModuleEvent) : void
      {
         UIModuleSmallLoading.Instance.hide();
         UIModuleSmallLoading.Instance.removeEventListener(Event.CLOSE,this.__onClose);
         UIModuleLoader.Instance.removeEventListener(UIModuleEvent.UI_MODULE_COMPLETE,this.__worldBossAwardComplete);
      ...
      private function __worldBossAwardProgress(param1:UIModuleEvent) : void
      {
