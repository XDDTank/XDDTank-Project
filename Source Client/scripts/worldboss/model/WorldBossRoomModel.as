package worldboss.model
{
   ...
   public class WorldBossRoomModel extends EventDispatcher
   {
      ...
      private var _list:Vector.<RankingPersonInfo>;
      
      private var _timeList:Vector.<WorldBossActiveTimeInfo>;
      ...
      {
         this._list = new Vector.<RankingPersonInfo>();
         this._timeList = new Vector.<WorldBossActiveTimeInfo>();
         super();
      ...
      public function set timeList(param1:Vector.<WorldBossActiveTimeInfo>) : void
      {
      ...
      public function set list(param1:Vector.<RankingPersonInfo>) : void
      {
         this._list = param1;
      }
