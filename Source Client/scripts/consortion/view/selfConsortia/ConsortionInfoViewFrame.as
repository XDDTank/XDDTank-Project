package consortion.view.selfConsortia
{
   ...
   public class ConsortionInfoViewFrame extends Frame
   {
      ...
      private function __takeIn(param1:MouseEvent) : void
      {
         SoundManager.instance.play("008");
      ...
      public function set info(param1:ConsortiaInfo) : void
      {
         ...
         var _loc2_:ConsortiaLevelInfo = ConsortionModelControl.Instance.model.getLevelData(this._info.Level == 10 ? int(this._info.Level) : int(this._info.Level + 1));
         ...
         {
            _loc3_ = this._info.Experience;
            _loc4_ = _loc2_.Experience;
         }
         else
         {
            _loc5_ = ConsortionModelControl.Instance.model.getLevelData(this._info.Level);
            _loc3_ = this._info.Experience - _loc5_.Experience;
