package consortion.view
{
   ...
   public class CountDesTip extends BaseTip
   {
      ...
      {
         this._info = param1 as ConsortiaInfo;
         if(this._info)
         {
            ...
            this._desI.text = LanguageMgr.GetTranslation("ddt.consortionSelfHallLeftView.countTipI",String(ConsortionModelControl.Instance.model.getLevelData(this._info.Level == 10 ? int(this._info.Level) : int(this._info.Level + 1)).Count));
