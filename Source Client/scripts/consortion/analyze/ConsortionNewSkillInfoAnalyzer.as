package consortion.analyze
{
   ...
   public class ConsortionNewSkillInfoAnalyzer extends DataAnalyzer
   {
      ...
      public function ConsortionNewSkillInfoAnalyzer(param1:Function)
      {
         super(param1);
      }
      ...
      override public function analyze(param1:*) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:ConsortionNewSkillInfo = null;
         ...
         if(_loc2_.@value == "true")
         {
            ...
            {
               _loc5_ = new ConsortionNewSkillInfo();
               ObjectUtils.copyPorpertiesByXML(_loc5_,_loc3_[_loc4_]);
               this.newSkillInfoList.push(_loc5_);
               _loc4_++;
            }
            onAnalyzeComplete();
         }
