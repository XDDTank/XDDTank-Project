package consortion
{
   ...
   public class ConsortionModelControl extends EventDispatcher
   {
      ...
      private function __consortiaResponse(param1:CrazyTankSocketEvent) : void
      {
         ...
         var _loc43_:InteractiveObject = null;
         ...
         switch(_loc3_)
         {
            case 1:
               ...
               else if(_loc6_.ID == PlayerManager.Instance.Self.ID)
               {
               ...
               if(_loc6_.ID == PlayerManager.Instance.Self.ID)
               {
                  ...
                  if(_loc7_)
                  {
                     _loc12_ = LanguageMgr.GetTranslation("tank.manager.PlayerManager.isInvent.msg",_loc6_.ConsortiaName);
                  }
                  else
                  {
                     _loc12_ = LanguageMgr.GetTranslation("tank.manager.PlayerManager.pass",_loc6_.ConsortiaName);
                  }
               ...
               else
               {
                  ...
                  PlayerManager.Instance.Self.consortiaInfo.Count = _loc11_;
                  _loc12_ = LanguageMgr.GetTranslation("tank.manager.PlayerManager.player",_loc6_.NickName);
               }
               _loc12_ = StringHelper.rePlaceHtmlTextField(_loc12_);
               ChatManager.Instance.sysChatYellow(_loc12_);
               break;
            case 2:
               ...
               ConsortionModelControl.Instance.model.deleteOneConsortion(_loc4_);
               break;
            case 3:
               _loc4_ = _loc2_.readInt();
               ...
               if(PlayerManager.Instance.Self.ID == _loc4_)
               {
                  ...
                  if(_loc15_)
                  {
                     _loc41_ = LanguageMgr.GetTranslation("tank.manager.PlayerManager.delect",_loc16_);
                     MessageTipManager.getInstance().show(LanguageMgr.GetTranslation("tank.manager.PlayerManager.hit"));
                  }
                  else
                  {
                     _loc41_ = LanguageMgr.GetTranslation("tank.manager.PlayerManager.leave");
                  }
                  if(StateManager.currentStateType == StateType.CONSORTIA)
                  {
                     StateManager.back();
                  ...
                  ChatManager.Instance.sysChatRed(_loc41_);
               }
               else
               {
                  this.removeConsortiaMember(_loc4_,_loc15_,_loc16_);
                  PlayerManager.Instance.Self.consortiaInfo.Count = _loc14_;
               }
               break;
            case 4:
               ...
               if(SharedManager.Instance.showCI)
               {
                  if(this.str != _loc20_)
                  {
                     ...
                     _loc42_ = _loc20_ + LanguageMgr.GetTranslation("tank.manager.PlayerManager.come",_loc22_);
                     _loc42_ = StringHelper.rePlaceHtmlTextField(_loc42_);
                     _loc43_ = StageReferance.stage.focus;
                     ...
                     this._enterConfirm = AlertManager.Instance.simpleAlert(LanguageMgr.GetTranslation("tank.manager.PlayerManager.request"),_loc42_,LanguageMgr.GetTranslation("tank.manager.PlayerManager.sure"),LanguageMgr.GetTranslation("tank.manager.PlayerManager.refuse"),false,true,true,LayerManager.ALPHA_BLOCKGOUND,CacheConsts.ALERT_IN_FIGHT);
                     this._enterConfirm.addEventListener(FrameEvent.RESPONSE,this.__enterConsortiaConfirm);
                     this.str = _loc20_;
                     if(_loc43_ is TextField)
                     {
                        if(TextField(_loc43_).type == TextFieldType.INPUT)
                        {
                           StageReferance.stage.focus = _loc43_;
                        }
                     }
                  }
               }
            ...
            case 6:
               ...
               _loc24_ = _loc2_.readUTF();
               _loc25_ = _loc2_.readInt();
               if(PlayerManager.Instance.Self.ConsortiaID == _loc23_)
               {
                  PlayerManager.Instance.Self.consortiaInfo.Level = _loc25_;
                  ChatManager.Instance.sysChatYellow(LanguageMgr.GetTranslation("tank.manager.PlayerManager.upgrade",_loc25_,this._model.getLevelData(_loc25_).Count));
                  TaskManager.instance.requestClubTask();
            ...
            case 8:
               ...
               if(_loc26_ != 1)
               {
                  if(_loc26_ == 2)
                  {
                     this.updateDutyInfo(_loc30_,_loc31_,_loc32_);
                  }
                  else if(_loc26_ == 3)
                  {
                     this.upDateSelfDutyInfo(_loc30_,_loc31_,_loc32_);
                  }
                  else if(_loc26_ == 4)
                  {
                     this.upDateSelfDutyInfo(_loc30_,_loc31_,_loc32_);
                  ...
                  {
                     this.updateConsortiaMemberDuty(_loc28_,_loc30_,_loc31_,_loc32_);
                     _loc44_ = "";
                     if(_loc28_ == PlayerManager.Instance.Self.ID)
                     {
                        _loc44_ = LanguageMgr.GetTranslation("tank.manager.PlayerManager.youUpgrade",_loc34_,_loc31_);
                     }
                     else if(_loc28_ == _loc33_)
                     {
                        _loc44_ = LanguageMgr.GetTranslation("tank.manager.PlayerManager.upgradeSelf",_loc29_,_loc31_);
                     }
                     else
                     {
                        _loc44_ = LanguageMgr.GetTranslation("tank.manager.PlayerManager.upgradeOther",_loc34_,_loc29_,_loc31_);
                     }
                  ...
                  else if(_loc26_ == 7)
                  {
                     ...
                     if(_loc28_ == PlayerManager.Instance.Self.ID)
                     {
                        _loc45_ = LanguageMgr.GetTranslation("tank.manager.PlayerManager.youDemotion",_loc34_,_loc31_);
                     }
                     else if(_loc28_ == _loc33_)
                     {
                        _loc45_ = LanguageMgr.GetTranslation("tank.manager.PlayerManager.demotionSelf",_loc29_,_loc31_);
                     }
                     else
                     {
                        _loc45_ = LanguageMgr.GetTranslation("tank.manager.PlayerManager.demotionOther",_loc34_,_loc29_,_loc31_);
                     }
                     _loc45_ = StringHelper.rePlaceHtmlTextField(_loc45_);
                     ChatManager.Instance.sysChatYellow(_loc45_);
                  }
                  else if(_loc26_ == 8)
                  {
                     this.updateConsortiaMemberDuty(_loc28_,_loc30_,_loc31_,_loc32_);
                  ...
                  {
                     this.updateConsortiaMemberDuty(_loc28_,_loc30_,_loc31_,_loc32_);
                     PlayerManager.Instance.Self.consortiaInfo.ChairmanName = _loc29_;
                     _loc46_ = "<" + _loc29_ + ">" + LanguageMgr.GetTranslation("tank.manager.PlayerManager.up") + _loc31_;
                     _loc46_ = StringHelper.rePlaceHtmlTextField(_loc46_);
                     ChatManager.Instance.sysChatYellow(_loc46_);
                     SoundManager.instance.play("1001");
                  }
               }
               break;
            case 9:
               ...
               if(_loc35_ != PlayerManager.Instance.Self.ConsortiaID)
               {
                  return;
               }
               _loc39_ = "";
               if(PlayerManager.Instance.Self.ID == _loc36_)
               {
                  _loc39_ = LanguageMgr.GetTranslation("tank.manager.PlayerManager.contributionSelf",_loc38_);
               }
               else
               {
                  _loc39_ = LanguageMgr.GetTranslation("tank.manager.PlayerManager.contributionOther",_loc37_,_loc38_);
               }
               ChatManager.Instance.sysChatYellow(_loc39_);
               break;
            case 10:
      ...
      private function __givceOffer(param1:CrazyTankSocketEvent) : void
      {
         ...
         if(_loc3_)
         {
            this._model.getConsortiaMemberInfo(PlayerManager.Instance.Self.ID).RichesOffer = this._model.getConsortiaMemberInfo(PlayerManager.Instance.Self.ID).RichesOffer + _loc2_;
            TaskManager.instance.onGuildUpdate();
         }
      }
      ...
      private function __consortiaInvitePass(param1:CrazyTankSocketEvent) : void
      {
         ...
         if(_loc2_)
         {
            this.setPlayerConsortia(_loc3_,_loc4_);
            this.getConsortionMember(this.memberListComplete);
            this.getConsortionList(this.selfConsortionComplete,1,6,_loc4_,-1,-1,-1,_loc3_);
      ...
      private function __consortiaInviteDetele(param1:CrazyTankSocketEvent) : void
      {
         var _loc2_:int = param1.pkg.readInt();
         var _loc3_:Boolean = param1.pkg.readBoolean();
         var _loc4_:String = param1.pkg.readUTF();
      ...
      private function __consortiaCreate(param1:CrazyTankSocketEvent) : void
      {
         ...
         if(_loc3_)
         {
            this.setPlayerConsortia(_loc2_,_loc4_);
            this.getConsortionMember(this.memberListComplete);
            this.getConsortionList(this.selfConsortionComplete,1,6,_loc4_,-1,-1,-1,_loc2_);
            dispatchEvent(new ConsortionEvent(ConsortionEvent.CONSORTION_STATE_CHANGE));
            TaskManager.instance.requestClubTask();
            if(PathManager.solveExternalInterfaceEnabel())
            {
               ExternalInterfaceManager.sendToAgent(4,PlayerManager.Instance.Self.ID,PlayerManager.Instance.Self.NickName,ServerManager.Instance.zoneName,-1,_loc4_);
            }
            SocketManager.Instance.out.SendenterConsortion(true);
         }
      }
      ...
      private function __consortiaDisband(param1:CrazyTankSocketEvent) : void
      {
         ...
         if(param1.pkg.readBoolean())
         {
            ...
            if(param1.pkg.readInt() == PlayerManager.Instance.Self.ID)
            {
               ...
               ConsortionModelControl.Instance.model.deleteOneConsortion(_loc2_);
            }
         }
         else
         {
      ...
      private function __renegadeUser(param1:CrazyTankSocketEvent) : void
      {
         ...
         if(_loc2_)
         {
            PlayerManager.Instance.Self.consortiaInfo.Count = _loc3_;
         }
      }
      ...
      private function __onConsortiaShopUp(param1:CrazyTankSocketEvent) : void
      {
         var _loc2_:Boolean = param1.pkg.readBoolean();
         var _loc3_:String = param1.pkg.readUTF();
         if(_loc2_)
         {
            PlayerManager.Instance.Self.consortiaInfo.ShopLevel += 1;
      ...
      private function __onConsortiahallUp(param1:CrazyTankSocketEvent) : void
      {
         var _loc2_:Boolean = param1.pkg.readBoolean();
         var _loc3_:String = param1.pkg.readUTF();
         if(_loc2_)
         {
            PlayerManager.Instance.Self.consortiaInfo.StoreLevel += 1;
      ...
      private function __onConsortiaskillUp(param1:CrazyTankSocketEvent) : void
      {
         var _loc2_:Boolean = param1.pkg.readBoolean();
         var _loc3_:String = param1.pkg.readUTF();
         if(_loc2_)
         {
            PlayerManager.Instance.Self.consortiaInfo.SmithLevel += 1;
      ...
      private function __dutyUpdata(param1:CrazyTankSocketEvent) : void
      {
         var _loc2_:Boolean = param1.pkg.readBoolean();
         var _loc3_:int = param1.pkg.readInt();
         var _loc4_:String = param1.pkg.readUTF();
      ...
      private function __skillChangehandler(param1:CrazyTankSocketEvent) : void
      {
         var _loc2_:int = param1.pkg.readInt();
         var _loc3_:Boolean = param1.pkg.readBoolean();
         var _loc4_:DictionaryData = PlayerManager.Instance.Self.isLearnSkill;
         if(_loc3_)
         {
      ...
      public function clubSearchConsortions(param1:ConsortionListAnalyzer) : void
      {
         ...
         this._model.consortionsListTotalCount = param1.consortionsTotalCount;
      }
      ...
      public function levelUpInfoComplete(param1:ConsortionLevelUpAnalyzer) : void
      {
      ...
      public function newSkillInfoListComplete(param1:ConsortionNewSkillInfoAnalyzer) : void
      {
         this._model.newSkillInfoList = param1.newSkillInfoList;
      }
      
      public function consortionProbabilityInfoListComplete(param1:ConsortiaShopListAnalyzer) : void
      {
         this._model.proBabiliInfoList = param1.ProbabilityInfoList;
      }
      ...
      public function getConsortionMember(param1:Function = null) : void
      {
         ...
         else
         {
            ...
            _loc3_ = LoadResourceManager.instance.createLoader(PathManager.solveRequestPath("ConsortiaUsersList.ashx"),BaseLoader.REQUEST_LOADER,_loc2_);
      ...
      private function __updateTaskRemainTime(param1:CrazyTankSocketEvent) : void
      {
         var _loc2_:PackageIn = param1.pkg;
         var _loc3_:int = _loc2_.readInt();
         ...
         this.model.receivedQuestCount = _loc6_;
         this.model.currentTaskLevel = _loc3_;
         if(ConsortionModelControl.Instance.model.getLevelData(PlayerManager.Instance.Self.consortiaInfo.Level))
         {
            this.model.remainPublishTime = ConsortionModelControl.Instance.model.getLevelData(PlayerManager.Instance.Self.consortiaInfo.Level).QuestCount - _loc5_;
         }
         this.model.lastPublishDate = _loc4_;
      ...
      private function __syncConsortionRich(param1:CrazyTankSocketEvent) : void
      {
         var _loc2_:PackageIn = param1.pkg;
         var _loc3_:int = _loc2_.readInt();
         PlayerManager.Instance.Self.consortiaInfo.Riches = _loc3_;
      }
      ...
      {
         var _loc1_:ClubViewFrame = null;
         _loc1_ = ComponentFactory.Instance.creatComponentByStylename("ClubViewFrame");
         _loc1_.show();
      }
   }
}
