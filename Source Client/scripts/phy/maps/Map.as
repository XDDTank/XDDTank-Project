package phy.maps
{
   ...
   public class Map extends Sprite
   {
      ...
      public function addToControlLayer(param1:DisplayObject) : void
      {
         this._controlLayer.addChild(param1);
      }
      ...
      protected function update(param1:Boolean = true) : void
      {
         var _loc3_:Physics = null;
      ...
      private function checkOverFrameRate() : void
      {
         ...
         else if(this._frameTimeOverCount > 0)
         {
      ...
      public function set groundScale(param1:Number) : void
      {
         if(this._ground)
         {
            this._ground.scaleX = this._ground.scaleY = param1;
         }
         else
         {
            this._stone.scaleX = this._stone.scaleY = param1;
         }
         this._livingLayer.scaleX = this._livingLayer.scaleY = param1;
         this._phyLayer.scaleX = this._phyLayer.scaleY = param1;
         this._mapThing.scaleX = this._mapThing.scaleY = param1;
      }
