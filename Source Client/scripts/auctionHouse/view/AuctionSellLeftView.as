package auctionHouse.view
{
   ...
   public class AuctionSellLeftView extends Sprite implements Disposeable
   {
      ...
      {
         var _loc1_:Bitmap = ComponentFactory.Instance.creatBitmap("auctionHouse.LeftBG2");
         addChild(_loc1_);
         var _loc2_:Scale9CornerImage = ComponentFactory.Instance.creatComponentByStylename("auctionHouse.SellViewBtnBg");
         addChild(_loc2_);
         var _loc3_:Scale9CornerImage = ComponentFactory.Instance.creatComponentByStylename("ddtauction.sellItemBG2");
         addChild(_loc3_);
         var _loc4_:Scale9CornerImage = ComponentFactory.Instance.creatComponentByStylename("ddtauction.sellItemBG3");
         addChild(_loc4_);
         var _loc5_:Scale9CornerImage = ComponentFactory.Instance.creatComponentByStylename("ddtauction.sellItemBG4");
         addChild(_loc5_);
         var _loc6_:FilterFrameText = ComponentFactory.Instance.creatComponentByStylename("auctionHouse.SellViewTextI");
         _loc6_.text = LanguageMgr.GetTranslation("tank.ddtauctionHouse.view.text");
         addChild(_loc6_);
         var _loc7_:FilterFrameText = ComponentFactory.Instance.creatComponentByStylename("auctionHouse.SellViewTextII");
         _loc7_.text = LanguageMgr.GetTranslation("tank.ddtauctionHouse.view.text1");
         addChild(_loc7_);
         var _loc8_:FilterFrameText = ComponentFactory.Instance.creatComponentByStylename("auctionHouse.SellViewTextIII");
         _loc8_.text = LanguageMgr.GetTranslation("tank.ddtauctionHouse.view.text2");
         addChild(_loc8_);
         var _loc9_:FilterFrameText = ComponentFactory.Instance.creatComponentByStylename("auctionHouse.SellViewTextIIII");
         _loc9_.text = LanguageMgr.GetTranslation("tank.ddtauctionHouse.view.text3");
         addChild(_loc9_);
         var _loc10_:FilterFrameText = ComponentFactory.Instance.creatComponentByStylename("auctionHouse.SellViewTextIIIII");
         _loc10_.text = LanguageMgr.GetTranslation("tank.ddtauctionHouse.view.text4");
         addChild(_loc10_);
         ...
         var _loc11_:MutipleImage = ComponentFactory.Instance.creat("auctionHouse.SellLeftIcon0");
         addChild(_loc11_);
         var _loc12_:MutipleImage = ComponentFactory.Instance.creat("auctionHouse.SellLeftIcon1");
         addChild(_loc12_);
         var _loc13_:MutipleImage = ComponentFactory.Instance.creat("auctionHouse.SellLeftIcon2");
         addChild(_loc13_);
