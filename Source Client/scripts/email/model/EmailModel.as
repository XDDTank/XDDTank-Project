package email.model
{
   ...
   public class EmailModel extends EventDispatcher
   {
      ...
      public function set currentEmail(param1:Array) : void
      {
         this._currentEmail = param1;
      }
      ...
      public function removeEmailArray(param1:Array) : void
      {
         var _loc2_:EmailInfo = null;
         var _loc3_:int = 0;
         for each(_loc2_ in param1)
         {
            _loc3_ = this._emails.indexOf(_loc2_);
            if(_loc3_ > -1)
            {
               this._emails.splice(_loc3_,1);
            }
         }
         this.getNoReadMails();
