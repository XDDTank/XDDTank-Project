package email.manager
{
   ...
   public class MailManager
   {
      ...
      public function getAllEmailLoader() : BaseLoader
      {
         ...
         var _loc2_:BaseLoader = LoadResourceManager.instance.createLoader(PathManager.solveRequestPath("LoadUserMail.ashx"),BaseLoader.COMPRESS_REQUEST_LOADER,_loc1_);
      ...
      {
         var _loc1_:URLVariables = RequestVairableCreater.creatWidthKey(true);
         var _loc2_:BaseLoader = LoadResourceManager.instance.createLoader(PathManager.solveRequestPath("MailSenderList.ashx"),BaseLoader.COMPRESS_REQUEST_LOADER,_loc1_);
      ...
      private function __deleteMail(param1:CrazyTankSocketEvent) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            _loc8_ = param1.pkg.readByte();
            _loc6_["id"] = _loc7_;
            _loc6_["isSuccess"] = _loc8_ >= 1 ? true : false;
         ...
         {
            if(_loc3_[_loc5_]["isSuccess"])
            {
               this.removeMail(this._model.getMailByID(_loc3_[_loc5_]["id"]));
               this.changeSelected(null);
      ...
      public function removeMailArray(param1:Array) : void
      {
         this._model.removeEmailArray(param1);
      }
      ...
      private function __responseMail(param1:CrazyTankSocketEvent) : void
      {
         ...
         if(_loc3_ == 5)
         {
            ...
            _loc5_ = LoadResourceManager.instance.createLoader(PathManager.solveRequestPath("ShopItemList.xml"),BaseLoader.COMPRESS_TEXT_LOADER,_loc4_);
            _loc5_.analyzer = new ShopItemAnalyzer(ShopManager.Instance.updateShopGoods);
