package email.view
{
   ...
   public class ReadingView extends Frame
   {
      ...
      private function initView() : void
      {
         ...
         var _loc1_:ScaleLeftRightImage = ComponentFactory.Instance.creatComponentByStylename("email.PageCountBg");
         addToContent(_loc1_);
         ...
         while(_loc2_ < 5)
         {
            this._diamonds[_loc2_] = new DiamondOfReading();
            this._diamonds[_loc2_].index = _loc2_;
            this._diamondHBox.addChild(this._diamonds[_loc2_]);
            _loc2_++;
         }
      ...
      private function hightGoods(param1:Array) : Boolean
      {
         ...
         {
            if(_loc5_.Money != 0 || _loc5_.BindMoney != 0)
            {
               _loc3_ = true;
            }
            _loc6_ = 1;
            while(_loc6_ <= 5)
            {
               ...
               {
                  _loc8_ = _loc5_[_loc7_] as InventoryItemInfo;
                  if(_loc8_)
                  {
                     if(!_loc3_)
                     {
                  ...
                  if(EquipType.isValuableEquip(_loc8_))
                  {
                     _loc2_ = false;
                     _loc4_ = true;
                     break;
