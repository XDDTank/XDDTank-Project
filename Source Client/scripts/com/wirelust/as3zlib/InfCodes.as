package com.wirelust.as3zlib
{
   final class InfCodes
   {
            ...
            else
            {
               do
               {
                  ...
                  if((_loc12_ & 16) != 0)
                  {
                     ...
                     while(_loc9_ += _loc10_[_loc24_ + 2], _loc9_ += _loc13_ & inflate_mask[_loc12_], _loc24_ = (_loc11_ + _loc9_) * 3, _loc12_ = _loc10_[_loc24_], true);
      ...
      function proc(param1:InfBlocks, param2:ZStream, param3:int) : int
      {
         var _loc4_:int = 0;
         ...
         _loc13_ = _loc12_ < param1.read ? int(param1.read - _loc12_ - 1) : int(param1.end - _loc12_);
         while(true)
         {
            if(false)
            {
