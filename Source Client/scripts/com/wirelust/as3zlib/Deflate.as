package com.wirelust.as3zlib
{
   ...
   public class Deflate
   {
      ...
      static function smaller(param1:Array, param2:int, param3:int, param4:Array) : Boolean
      {
      ...
      function pqdownheap(param1:Array, param2:int) : void
      {
      ...
      function scan_tree(param1:Array, param2:int) : void
      {
         var _loc3_:int = 0;
         var _loc5_:int = 0;
         var _loc4_:int = -1;
      ...
      function copy_block(param1:int, param2:int, param3:Boolean) : void
      {
         var _loc4_:int = 0;
         this.bi_windup();
         this.last_eob_len = 8;
      ...
      function flush_block_only(param1:Boolean) : void
      {
      ...
      public function deflate_stored(param1:int) : int
      {
         ...
         if(this.strm.avail_out == 0)
         {
            return param1 == Z_FINISH ? int(FinishStarted) : int(NeedMore);
         }
         return param1 == Z_FINISH ? int(FinishDone) : int(BlockDone);
      }
      ...
      function _tr_flush_block(param1:int, param2:int, param3:Boolean) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
      ...
      function longest_match(param1:int) : int
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
      ...
      function deflateReset(param1:ZStream) : int
      {
      ...
      function deflateParams(param1:ZStream, param2:int, param3:int) : int
      {
         var _loc4_:int = Z_OK;
         if(param2 == Z_DEFAULT_COMPRESSION)
         {
      ...
      function deflateSetDictionary(param1:ZStream, param2:ByteArray, param3:int) : int
      {
