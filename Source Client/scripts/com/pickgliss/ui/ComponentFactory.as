package com.pickgliss.ui
{
   ...
   public final class ComponentFactory
   {
      ...
      public function creatComponentByStylename(param1:String) : *
      {
         var _loc2_:XML = this.getComponentStyle(param1);
         var _loc3_:String = _loc2_.@classname;
         var _loc4_:* = ClassUtils.CreatInstance(_loc3_);
         _loc4_.id = this.componentID;
         this._allComponents[_loc4_.id] = _loc4_;
         if(ClassUtils.classIsComponent(_loc3_))
         {
            _loc4_.beginChanges();
            ObjectUtils.copyPorpertiesByXML(_loc4_,_loc2_);
