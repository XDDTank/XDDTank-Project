package com.pickgliss.ui
{
   ...
   public final class AlertManager
   {
      ...
      public function simpleAlert(param1:String, param2:String, param3:String = "", param4:String = "", param5:Boolean = false, param6:Boolean = false, param7:Boolean = false, param8:int = 0, param9:String = null, param10:String = "SimpleAlert", param11:int = 30, param12:Boolean = true) : BaseAlerFrame
      {
         if(StringUtils.isEmpty(param3))
         {
            param3 = DEFAULT_CONFIRM_LABEL;
         }
         var _loc13_:AlertInfo = new AlertInfo();
         ObjectUtils.copyProperties(_loc13_,this._simpleAlertInfo);
         _loc13_.sound = this._simpleAlertInfo.sound;
         _loc13_.data = param2;
         _loc13_.autoDispose = param5;
         _loc13_.title = param1;
         _loc13_.submitLabel = param3;
         _loc13_.cancelLabel = param4;
         _loc13_.enableHtml = param6;
         _loc13_.mutiline = param7;
         _loc13_.buttonGape = param11;
         _loc13_.autoButtonGape = param12;
         if(StringUtils.isEmpty(param4))
         {
            _loc13_.showCancel = false;
         }
         return this.alert(param10,_loc13_,param8,param9);
      }
   }
}
