package com.pickgliss.ui.vo
{
   ...
   public class AlertInfo extends EventDispatcher
   {
      ...
      public function AlertInfo(param1:String = "", param2:String = "确 定", param3:String = "取 消", param4:Boolean = true, param5:Boolean = true, param6:Object = null, param7:Boolean = true, param8:Boolean = true, param9:Boolean = true, param10:Boolean = true, param11:int = 20, param12:int = 30, param13:Boolean = false)
      {
      ...
      public function set carryData(param1:Object) : void
      {
         this._carryData = param1;
      }
   }
}
