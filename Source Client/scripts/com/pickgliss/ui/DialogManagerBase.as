package com.pickgliss.ui
{
   ...
   public class DialogManagerBase extends EventDispatcher
   {
      ...
      public function setup(param1:String) : void
      {
         ...
         _loc2_.addEventListener(Event.COMPLETE,this.__configComplete);
         _loc2_.load(new URLRequest(param1 + "?lv=" + getTimer() * Math.random()));
      }
      ...
      private function __switchDialog(param1:MouseEvent = null) : void
      {
      ...
      private function __configComplete(param1:Event = null) : void
      {
         var _loc2_:URLLoader = param1.currentTarget as URLLoader;
         _loc2_.removeEventListener(Event.COMPLETE,this.__configComplete);
         this._config = new XML(_loc2_.data);
      }
      
      private function createDialogUI() : void
      {
         var resultXML:XMLList = null;
         var chat:XML = null;
      ...
      private function __dialogTimeout(param1:TimerEvent) : void
      {
         this.__switchDialog();
      }
      
      public function showDialog(param1:int, param2:Number = 0, param3:Boolean = true, param4:Boolean = true, param5:Boolean = true, param6:int = 4) : void
      {
         var resultXML:XMLList = null;
         var id:int = param1;
         var timeout:Number = param2;
         var enableKeybord:Boolean = param3;
         var enableMouse:Boolean = param4;
         var needCurtain:Boolean = param5;
         var curtainSpeed:int = param6;
         if(!this._parent)
         {
      ...
      public function dropGoodsId(param1:int) : int
      {
         var resultXML:XMLList = null;
         var id:int = param1;
         if(this._config)
      ...
      public function dropGoodsBeforeDialog(param1:int) : Boolean
      {
         var resultXML:XMLList = null;
         var id:int = param1;
         if(this._config)
      ...
      public function hasDialogs(param1:int) : Boolean
      {
         var resultXML:XMLList = null;
         var count:uint = 0;
         var chat:XML = null;
      ...
      public function getDropPoint(param1:int) : Point
      {
         var resultXML:XMLList = null;
         var id:int = param1;
      ...
      private function __curtainMoveAppear(param1:Event) : void
      {
         this._topSprite.y += this._curtainSpeed;
         this._bottomSprite.y -= this._curtainSpeed;
         this._mask.alpha += 0.04;
      ...
      private function __curtainMoveDisappear(param1:Event) : void
      {
         this._topSprite.y -= this._curtainSpeed;
         this._bottomSprite.y += this._curtainSpeed;
         this._mask.alpha -= 0.04;
      ...
      protected function Self(param1:int) : DisplayObject
      {
         return new Sprite();
      }
