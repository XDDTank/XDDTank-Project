package com.pickgliss.ui.controls
{
   ...
   public class SelectedTextButton extends SelectedButton
   {
      ...
      public function set selectedButtonOuterRectPosString(param1:String) : void
      {
         if(this._selectedButtonOuterRectPosString == param1)
         {
            return;
         }
         this._selectedButtonOuterRectPosString = param1;
      ...
      private function upSelecetdButtonPos() : void
      {
         ...
         var _loc1_:Point = this._selectedButtonOuterRectPos.getPos(_selectedButton.width,_selectedButton.height,_selectedButton.width,_selectedButton.height);
         _selectedButton.x = _loc1_.x;
         _selectedButton.y = _loc1_.y;
      }
   }
}
