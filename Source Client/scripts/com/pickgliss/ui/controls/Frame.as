package com.pickgliss.ui.controls
{
   ...
   public class Frame extends Component
   {
      ...
      public function set helpButton(param1:BaseButton) : void
      {
         if(this._helpButton == param1)
         {
            return;
         }
         if(this._helpButton)
      ...
      public function set helpInnerRectString(param1:String) : void
      {
         if(this._helpInnerRectString == param1)
         {
            return;
         }
         this._helpInnerRectString = param1;
      ...
      public function set helpstyle(param1:String) : void
      {
         if(this._helpStyle == param1)
         {
            return;
         }
         this._helpStyle = param1;
