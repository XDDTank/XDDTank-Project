package com.pickgliss.utils
{
   ...
   public final class DoubleClickManager
   {
      ...
      public function enableDoubleClick(param1:InteractiveObject) : void
      {
         ...
         param1.addEventListener(MouseEvent.MOUSE_UP,this.__mouseUpHandler);
      }
      ...
      public function disableDoubleClick(param1:InteractiveObject) : void
      {
         ...
         param1.removeEventListener(MouseEvent.MOUSE_UP,this.__mouseUpHandler);
      }
      ...
      protected function __mouseUpHandler(param1:MouseEvent) : void
      {
