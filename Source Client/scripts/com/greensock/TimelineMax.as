package com.greensock
{
   ...
   public class TimelineMax extends TimelineLite implements IEventDispatcher
   {
      ...
      public function tweenTo(param1:*, param2:Object = null) : TweenLite
      {
         ...
         _loc5_ = new TweenLite(this,Number(Math.abs(Number(_loc3_.currentTime) - this.cachedTime) / this.cachedTimeScale) || Number(0.001),_loc3_);
            ...
            if(this.cachedTime - _loc5_ > 0)
            {
               ...
               while(_loc8_)
               {
                  ...
                  if(_loc8_.active || !_loc8_.cachedPaused && _loc8_.cachedStartTime <= this.cachedTime && !_loc8_.gc)
                  {
                     ...
                     {
                        _loc13_ = !!_loc8_.cacheIsDirty ? Number(_loc8_.totalDuration) : Number(_loc8_.cachedTotalDuration);
