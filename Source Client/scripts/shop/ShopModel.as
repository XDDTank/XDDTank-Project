package shop
{
   ...
   public class ShopModel extends EventDispatcher
   {
      ...
      public function isOverCount(param1:ShopItemInfo) : Boolean
      {
         ...
         return _loc2_ >= param1.LimitCount && param1.LimitCount != -1 ? Boolean(true) : Boolean(false);
      }
      ...
      public function removeTempEquip(param1:ShopCarItemInfo) : void
      {
         ...
         if(_loc3_)
         {
            ...
            if(_loc4_)
            {
               ...
               {
                  _loc3_.setPartStyle(param1.TemplateInfo,param1.TemplateInfo.NeedSex,_loc4_.TemplateID,_loc4_.Color);
               }
            ...
            {
               _loc3_.setPartStyle(param1.TemplateInfo,param1.TemplateInfo.NeedSex);
               if(param1.CategoryID == EquipType.FACE)
               {
                  _loc3_.Skin = "";
               }
      ...
      {
         var _loc3_:Array = [2,4,0,5,8,3,1,7];
         if(!param2)
         {
