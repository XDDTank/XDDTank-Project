   ...
   public class NewShopBugleView extends Sprite implements Disposeable
   {
      ...
      protected function __onKeyDownd(param1:KeyboardEvent) : void
      {
         ...
         if(this._itemGroup.selectIndex != _loc2_)
         {
            ...
            this._text2.text = this.info.getItemPrice(_loc2_ + 1).moneyValue + LanguageMgr.GetTranslation("ddtMoney");
         }
      ...
      {
         var _loc2_:NewShopBugViewItem = null;
         SoundManager.instance.play("008");
         switch(param1.responseCode)
         {
            ...
            case FrameEvent.ENTER_CLICK:
               ...
               _loc2_ = this._itemContainer.getChildAt(this._itemGroup.selectIndex) as NewShopBugViewItem;
               if(PlayerManager.Instance.Self.totalMoney < _loc2_.money)
               {
      ...
      private function addItem(param1:ShopItemInfo, param2:int) : void
      {
         ...
         var _loc5_:NewShopBugViewItem = new NewShopBugViewItem(param2,param1.getTimeToString(param2),param1.getItemPrice(param2).moneyValue,_loc4_);
      ...
      {
         SoundManager.instance.play("008");
         this._itemGroup.selectIndex = this._itemContainer.getChildIndex(param1.currentTarget as NewShopBugViewItem);
         this._text2.text = (param1.currentTarget as NewShopBugViewItem).money + LanguageMgr.GetTranslation("ddtMoney");
      }
