package ddt.view.tips
{
   ...
   public class TotemTips extends BaseTip implements ITip, Disposeable
   {
      ...
      override protected function init() : void
      {
         ...
         while(_loc1_ < 10)
         {
            this._PropVec[_loc1_] = ComponentFactory.Instance.creatComponentByStylename("TotemTips.propTxt");
            _loc1_++;
         }
         super.init();
      ...
      {
         var _loc1_:Array = ["Lv1. 攻击 +9","Lv2. 攻击 +18","Lv3. 攻击 +27","Lv4. 攻击 +36","Lv5. 攻击 +45","Lv6. 攻击 +54","Lv7. 攻击 +63","Lv8. 攻击 +72","Lv9. 攻击 +81","Lv10. 攻击 +90"];
         var _loc2_:int = 0;
         while(_loc2_ < 10)
         {
            if(_loc2_ < 5)
            {
               ...
               this._PropVec[_loc2_].y = this._rule4.y + this._rule4.height + 8 + 20 * _loc2_;
            }
            else
            {
               this._PropVec[_loc2_].text = _loc1_[_loc2_];
               this._PropVec[_loc2_].x = 124;
               this._PropVec[_loc2_].y = this._rule4.y + this._rule4.height + 8 + 20 * (_loc2_ - 5);
            }
            this._thisHeight = this._PropVec[_loc2_].y + this._PropVec[_loc2_].textHeight;
            _loc2_++;
         }
      }
