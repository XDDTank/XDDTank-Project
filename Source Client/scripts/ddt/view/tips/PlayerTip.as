   ...
   public class PlayerTip extends Sprite implements Disposeable
   {
      ...
      public function update() : void
      {
         ...
         if(this._info)
         {
            ...
            {
               ObjectUtils.disposeObject(this._vipName);
               this._vipName = VipController.instance.getVipNameTxt(138,_loc1_.VIPtype);
         ...
         {
            this.btnChallenge.enable = StateManager.currentStateType == StateType.MAIN ? Boolean(true) : Boolean(false);
         ...
         if(_loc1_ && _loc1_.DutyLevel > PlayerManager.Instance.Self.DutyLevel && _loc1_.ID != PlayerManager.Instance.Self.ID)
         {
            if(_loc1_.ConsortiaID != 0 && _loc1_.ConsortiaID == PlayerManager.Instance.Self.ConsortiaID)
            {
               ...
               this._btnPromote.visible = ConsortiaDutyManager.GetRight(PlayerManager.Instance.Self.Right,ConsortiaDutyType._12_UpGrade) && _loc1_.DutyLevel != 2 && ConsortionModelControl.Instance.model.ViceChairmanConsortiaMemberList.length < 3;
               this._btnDemote.visible = ConsortiaDutyManager.GetRight(PlayerManager.Instance.Self.Right,ConsortiaDutyType._12_UpGrade) && _loc1_.DutyLevel != 3;
         ...
         else
         {
            ...
            {
               this._btnInvite.visible = ConsortiaDutyManager.GetRight(PlayerManager.Instance.Self.Right,ConsortiaDutyType._2_Invite) && _loc1_.ConsortiaID == 0 && _loc1_.playerState.StateID != 0;
         ...
         if(this._info)
         {
            switch(param1.currentTarget)
            {
               ...
               case this.btnChallenge:
                  ...
                  else if(PlayerManager.Instance.checkExpedition())
                  {
