   ...
   public class PlayerThumbnailTip extends Sprite implements Disposeable, ITip
   {
      ...
      public function dispose() : void
      {
         ...
         while(_loc1_ < this._items.length)
         {
            ...
            _loc2_.removeEventListener(MouseEvent.ROLL_OVER,this.__onMouseOver);
            _loc2_.removeEventListener(MouseEvent.ROLL_OUT,this.__onMouseOut);
            _loc2_.removeEventListener(MouseEvent.CLICK,this.__onMouseClick);
