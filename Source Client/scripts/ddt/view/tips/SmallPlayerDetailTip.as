package ddt.view.tips
{
   ...
   public class SmallPlayerDetailTip extends BaseTip implements ITip
   {
      ...
      public function SmallPlayerDetailTip()
      {
         super();
      }
      ...
      override protected function init() : void
      {
         ...
         this._petAsset = new PetSmallItem(_loc1_);
      ...
      override public function set tipData(param1:Object) : void
      {
         ...
         if(this._info)
         {
            if(this._info.playerInfo)
            {
               ...
               _loc2_ = this._info.character.getShowBitmapBig();
               _loc3_ = new BitmapData(_loc2_.width,_loc2_.height,true,0);
               _loc3_.draw(_loc2_);
               this._playerImg = new Bitmap(_loc3_,"auto",true);
