package ddt.view.tips
{
   ...
   public class TotemIconTips extends BaseTip implements ITip, Disposeable
   {
      ...
      override public function set tipData(param1:Object) : void
      {
         if(param1)
         {
            ...
            else
            {
               ...
               this._contentTxt.text = param1.toString();
      ...
      {
         this._tipTilte.visible = param1;
         this._levelTxt.visible = param1;
         this._contentTxt.visible = !param1;
      }
      
      private function showHeadPart() : void
      {
         var _loc1_:int = TotemManager.instance.getTotemPointLevel(this._playerInfo.totemId);
         this._tipTilte.text = "图腾等级:";
         this._levelTxt.text = TotemManager.instance.getCurrentLv(_loc1_).toString() + "级";
