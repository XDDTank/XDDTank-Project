package ddt.view.character
{
   ...
   public class BaseLayer extends Sprite implements ILayer
   {
      ...
      {
         return PathManager.solveGoodsPath(this._info,this._pic,this._info.NeedSex == 1,SHOW,this._hairType,String(param1),this._info.Level,this._gunBack,int(this._info.Property1));
      }
