package ddt.view.character
{
   ...
   public class BaseCharacter extends Sprite implements ICharacter, Disposeable
   {
      ...
      public function set LightVible(param1:Boolean) : void
      {
         this._lightVible = param1;
      }
      ...
      {
         if(param1.changedProperties[PlayerInfo.STYLE] || param1.changedProperties[PlayerInfo.COLORS] || param1.changedProperties[PlayerInfo.NIMBUS] || GameManager.Instance.MissionOverType == ExpView.GAME_OVER_TYPE_2)
         {
