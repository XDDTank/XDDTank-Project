   ...
   public class BaseCharacterLoader implements ICharacterLoader
   {
      ...
      protected function drawCharacter() : void
      {
         ...
         for(; _loc3_ >= 0; _loc3_--)
         {
            ...
            {
               if(this._layers[_loc3_].info.CategoryID != EquipType.SUITS && this._layers[_loc3_].info.CategoryID != EquipType.WING && !EquipType.isWeapon(this._layers[_loc3_].info.TemplateID))
               {
                  continue;
               }
            }
      ...
      public function update() : void
      {
         ...
         if(this._info && this._info.Style && this._layers)
         {
            ...
            while(_loc5_ < _loc1_.length)
            {
               ...
               if(!EquipType.isOffHand(_loc1_[_loc5_].split("|")[0]))
               {
            ...
            if(this._info && _loc3_ && !_loc4_ && !this._info.getShowSuits() && !this._info.wingHide)
            {
