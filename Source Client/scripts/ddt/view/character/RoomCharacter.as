package ddt.view.character
{
   ...
   public class RoomCharacter extends BaseCharacter
   {
      ...
      private function updateLight() : void
      {
         ...
         var _loc1_:PlayerInfo = PlayerManager.Instance.findPlayer(_info.ID,-1);
      ...
      private function callBack02(param1:SinpleLightLayer) : void
      {
         ...
         if(this._light2 != null)
         {
            ...
            else if(_info.Sinple == 200)
            {
               this._light2.x = -22;
               this._light2.y = 103;
            }
            else if(_info.Sinple == 300)
            {
               this._light2.x = -26;
               this._light2.y = 77;
            }
            else if(_info.Sinple == 400)
            {
               this._light2.x = -29;
               this._light2.y = 98;
            }
            else if(_info.Sinple == 500)
            {
               this._light2.x = -39;
               this._light2.y = 98;
            }
            else if(_info.Sinple == 600)
            {
               this._light2.x = -66;
               this._light2.y = 99;
            }
