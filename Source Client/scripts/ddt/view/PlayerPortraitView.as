package ddt.view
{
   ...
   public class PlayerPortraitView extends Sprite implements Disposeable
   {
      ...
      public function PlayerPortraitView(param1:String = "left", param2:int = 0, param3:Bitmap = null)
      {
         super();
         if(param3 == null)
         {
            param3 = ComponentFactory.Instance.creatBitmap("asset.ddtgift.playerIcon");
         }
      ...
      private function __characterComplete(param1:Event) : void
      {
         ...
         if(this._type == 1)
         {
            ...
            this._figure.x = this._directrion == LEFT ? Number(0) : Number(73);
            this._figure.y = 5;
         }
         else if(!this._character.info.getShowSuits())
         {
            ...
            this._figure.x = this._directrion == LEFT ? Number(0) : Number(85);
            this._figure.y = 7;
         }
         else
         {
