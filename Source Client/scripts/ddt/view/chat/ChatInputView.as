package ddt.view.chat
{
   ...
   public class ChatInputView extends Sprite
   {
      ...
      public function set channel(param1:int) : void
      {
         ...
         this._channelState.setFrame(this._channel == ChatInputView.WORLDBOSS_ROOM || this._channel == ChatInputView.CONSORTIA_VIEW ? int(5 + 1) : int(this._channel + 1));
