package ddt.data.quest
{
   ...
   public class QuestInfo
   {
      ...
      public static function createFromXML(param1:XML) : QuestInfo
      {
         ...
         _loc2_.SortLevel = param1.@SortLevel;
         ...
         _loc2_.CanRepeat = param1.@CanRepeat == "true" ? Boolean(true) : Boolean(false);
         _loc2_.RepeatInterval = param1.@RepeatInterval;
         _loc2_.RepeatMax = param1.@RepeatMax;
         _loc2_.RewardHonor = param1.@RewardHonor;
         _loc2_.RewardGold = param1.@RewardGold;
         _loc2_.RewardMagicSoul = param1.@RewardMagicSoul;
         ...
         _loc2_.RewardDailyActivity = param1.@RewardDailyActivity;
         ...
         _loc2_.StartDate = DateUtils.dealWithStringDate(String(param1.@StartDate).replace("T"," "));
         _loc2_.EndDate = DateUtils.dealWithStringDate(String(param1.@EndDate).replace("T"," "));
         ...
         _loc2_.LimitNodes = param1.@LimitNodes;
         _loc2_.GuideType = param1.@GuideType;
         _loc2_.GuideSceneID = param1.@GuideSceneID;
         _loc2_.RewardOffer = param1.@RewardOffer;
         _loc2_.RewardConsortiaGP = param1.@RewardConsortiaGP;
         _loc2_.RewardConsortiaRiches = param1.@RewardConsortiaRiches;
      ...
      private function getProgressById(param1:uint) : uint
      {
         ...
         var _loc8_:int = 0;
         var _loc9_:int = 0;
         var _loc10_:Vector.<PetInfo> = null;
         var _loc11_:uint = 0;
         var _loc12_:uint = 0;
         ...
         var _loc17_:InventoryItemInfo = null;
         var _loc18_:PetInfo = null;
         ...
         switch(_loc3_.type)
         {
            ...
            case 9:
               ...
               {
                  if(_loc16_.StrengthenLevel >= _loc3_.target)
                  {
               ...
               {
                  if(_loc17_.StrengthenLevel >= _loc3_.target)
                  {
                     _loc4_ = _loc3_.target;
                     break;
                  }
            ...
            case 16:
               ...
               break;
            case 17:
               _loc4_ = !!_loc2_.IsMarried ? int(1) : int(0);
               break;
            case 18:
               switch(_loc3_.param)
               {
            ...
            case 56:
               ...
               {
                  _loc4_ = Math.floor((PlayerManager.Instance.Self.totemId - 10000) / 7);
               }
               break;
            case 58:
               _loc4_ = PetBagManager.instance().petModel.spaceLevel;
               break;
            case 61:
               _loc4_ = PlayerManager.Instance.Self.getStrengthCompleteCount(_loc3_.param2);
               break;
            case 50:
               _loc10_ = PetBagManager.instance().petModel.getpetListSorted();
               _loc11_ = 0;
               for each(_loc18_ in _loc10_)
               {
                  if(_loc18_.Level >= _loc3_.param2)
                  {
                     _loc11_++;
                  }
               }
               if(_loc11_ > _loc3_.param)
               {
            ...
            case 57:
               _loc12_ = 0;
               for each(_loc19_ in BeadManager.instance.beadBag.items)
               {
                  if(_loc19_.beadLevel >= _loc3_.param2)
                  {
                     _loc12_++;
                  }
               }
               if(_loc12_ > _loc3_.param)
               {
                  _loc4_ = _loc3_.param2;
               }
               else
               ...
               break;
            case 62:
               _loc13_ = new Array(0,0,0,0,0,0);
               _loc14_ = _loc2_.getBag(BagInfo.EQUIPBAG).findSuitsForEach(_loc3_.param);
               _loc20_ = 0;
               while(_loc20_ < _loc14_.length)
               {
                  if(_loc14_[_loc20_].TemplateType < 7)
                  {
                     _loc13_[_loc14_[_loc20_].TemplateType - 1] = 1;
                  }
                  _loc20_++;
               }
               _loc15_ = 0;
      ...
      public function get conditionStatus() : Array
      {
         ...
         while(this._conditions[_loc2_])
         {
            ...
            else if(this._conditions[_loc2_].type == 9 || this._conditions[_loc2_].type == 12 || this._conditions[_loc2_].type == 17 || this._conditions[_loc2_].type == 21 || this._conditions[_loc2_].type == 50 || this._conditions[_loc2_].type == 57 || this._conditions[_loc2_].type == 61 || this._conditions[_loc2_].type == 62 || this._conditions[_loc2_].type == LivenessModel.RANDOM_PVE)
            {
