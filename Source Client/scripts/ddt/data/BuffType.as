package ddt.data
{
   public class BuffType
   {
      ...
      {
         return param1.id >= 50 && param1.id <= 79 && param1.id != 72;
      }
      ...
      public static function isArenaBufferByID(param1:int) : Boolean
      {
         switch(param1)
         {
            case ARENA_MARS:
      ...
      public static function isMilitaryBuff(param1:int) : Boolean
      {
         switch(param1)
         {
