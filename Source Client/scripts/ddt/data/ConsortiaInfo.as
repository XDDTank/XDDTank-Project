package ddt.data
{
   ...
   public class ConsortiaInfo extends EventDispatcher
   {
      ...
      public function set IsUsable(param1:Boolean) : void
      {
         this._isUsable = param1;
      }
