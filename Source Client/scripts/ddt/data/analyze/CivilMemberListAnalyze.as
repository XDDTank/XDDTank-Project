package ddt.data.analyze
{
   ...
   public class CivilMemberListAnalyze extends DataAnalyzer
   {
      ...
      override public function analyze(param1:*) : void
      {
         ...
         var _loc7_:CivilPlayerInfo = null;
         ...
         if(_loc2_.@value == "true")
         {
            ...
            while(_loc4_ < _loc3_.length())
            {
               ...
               _loc6_ = _loc3_[_loc4_].@IsVIP == "true" ? Boolean(true) : Boolean(false);
               if(_loc6_)
               {
                  _loc5_.VIPtype = 2;
               }
               ...
               _loc7_ = new CivilPlayerInfo();
               _loc7_.UserId = _loc5_.ID;
               _loc7_.MarryInfoID = _loc3_[_loc4_].@ID;
               _loc7_.IsPublishEquip = this.converBoolean(_loc3_[_loc4_].@IsPublishEquip);
               _loc7_.Introduction = _loc3_[_loc4_].@Introduction;
               _loc7_.IsConsortia = this.converBoolean(_loc3_[_loc4_].@IsConsortia);
               _loc7_.info = _loc5_;
               this.civilMemberList.push(_loc7_);
