package ddt.data.analyze
{
   ...
   public class VipPrivilegeConfigAnalyzer extends DataAnalyzer
   {
      ...
      public function VipPrivilegeConfigAnalyzer(param1:Function)
      {
         super(param1);
      }
      ...
      override public function analyze(param1:*) : void
      {
         ...
         if(_loc2_.@value == "true")
         {
            ...
            {
               _loc5_ = new VipConfigInfo();
               ObjectUtils.copyPorpertiesByXML(_loc5_,_loc3_[_loc4_]);
               this.vipConfigInfoList.add(_loc5_.ID,_loc5_);
               _loc4_++;
            }
            onAnalyzeComplete();
         }
