package ddt.data.analyze
{
   ...
   public class InvitedFriendListAnalyzer extends DataAnalyzer
   {
      ...
      public function InvitedFriendListAnalyzer(param1:Function)
      {
         super(param1);
      }
      ...
      override public function analyze(param1:*) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:InvitedFirendListPlayer = null;
         var _loc6_:PlayerState = null;
         var _loc2_:XML = new XML(param1);
         this.friendlist = new DictionaryData();
         if(_loc2_.@value == "true")
         {
            this.invitedAwardStep = _loc2_.@AwardStep;
            this.InviterID = _loc2_.@InviterID;
            _loc3_ = _loc2_..Item;
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length())
            {
               _loc5_ = new InvitedFirendListPlayer();
               ...
               _loc5_.apprenticeshipState = _loc2_.Item[_loc4_].@ApprenticeshipState;
               this.friendlist.add(_loc5_.UserID,_loc5_);
               _loc4_++;
            }
            onAnalyzeComplete();
         }
