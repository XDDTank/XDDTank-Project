package ddt.manager
{
   ...
   public class ChurchManager extends EventDispatcher
   {
      ...
      public function set resposeFrameCount(param1:uint) : void
      {
         this._resposeFrameCount = param1;
      }
      ...
      public function showChurchlist(param1:Function, param2:String) : void
      {
      ...
      protected function __churchlistComplete(param1:UIModuleEvent) : void
      {
         UIModuleSmallLoading.Instance.hide();
         UIModuleSmallLoading.Instance.removeEventListener(Event.CLOSE,this.__onClose);
         UIModuleLoader.Instance.removeEventListener(UIModuleEvent.UI_MODULE_COMPLETE,this.__churchlistComplete);
      ...
      protected function __churchtProgress(param1:UIModuleEvent) : void
      {
