package ddt.manager
{
   ...
   public class StateManager
   {
      ...
      public static function setState(param1:String = "default", param2:Object = null) : void
      {
         var _loc3_:BaseStateView = getState(param1);
      ...
      public static function createStateAsync(param1:String, param2:Function, param3:Boolean = false) : void
      {
      ...
      {
         return param1 != StateType.FIGHTING && param1 != StateType.MULTISHOOT_FIGHTING && param1 != StateType.MATCH_ROOM && param1 != StateType.MISSION_ROOM && param1 != StateType.DUNGEON_ROOM && param1 != StateType.CHALLENGE_ROOM && param1 != StateType.ROOM_LOADING && param1 != StateType.FIGHT_LIB && param1 != StateType.TRAINER1 && param1 != StateType.TRAINER2;
      }
