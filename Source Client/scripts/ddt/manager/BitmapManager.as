package ddt.manager
{
   ...
   public class BitmapManager implements Disposeable
   {
      ...
      public static function LoadPic(param1:Function, param2:ItemTemplateInfo) : void
      {
         var _loc3_:BaseLoader = null;
         _loc3_ = LoadResourceManager.instance.createLoader(PathManager.solveGoodsPath(param2,param2.Pic,param2.NeedSex == 1),BaseLoader.BITMAP_LOADER);
