package ddt.manager
{
   ...
   public class MessageTipManager
   {
      ...
      private function showByTimer(param1:TimerEvent) : void
      {
         ...
         {
            _loc2_ = this._showArr[0]["str"];
            _loc3_ = this._showArr[0]["type"];
            _loc4_ = this._showArr[0]["replace"];
            _loc5_ = this._showArr[0]["duration"];
            this._showArr.shift();
            this.showMsg(_loc2_,_loc3_,_loc4_,_loc5_);
         }
      ...
      private function showMsg(param1:String, param2:int = 0, param3:Boolean = false, param4:Number = 0.3) : void
      {
      ...
      public function show(param1:String, param2:int = 0, param3:Boolean = false, param4:Number = 0.3) : void
      {
         ...
         if(!this._showTimer)
         {
            this.showMsg(param1,param2,param3,param4);
            this._showTimer = new Timer(1000,1);
            this._showTimer.addEventListener(TimerEvent.TIMER,this.showByTimer);
            this._showTimer.start();
         }
         else if(this._showTimer.running)
         {
            if(this._showArr.length > 0 && param1 != this._showArr[this._showArr.length - 1]["str"])
            {
               _loc5_ = new Dictionary();
               _loc5_["str"] = param1;
               _loc5_["type"] = param2;
               _loc5_["replace"] = param3;
               _loc5_["duration"] = param4;
               this._showArr.push(_loc5_);
            }
         }
         else if(this._showArr.length >= 1)
         {
