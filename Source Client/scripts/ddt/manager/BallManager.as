package ddt.manager
{
   ...
   public class BallManager
   {
      ...
      {
         if(DisplayLoader.Context.applicationDomain.hasDefinition(solveBlastOutMovieName(param1)))
         {
      ...
      {
         if(DisplayLoader.Context.applicationDomain.hasDefinition(solveBulletMovieName(param1)))
         {
      ...
      {
         if(DisplayLoader.Context.applicationDomain.hasDefinition(solveShootMovieMovieName(param1)))
         {
