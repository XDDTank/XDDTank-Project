package ddt.manager
{
   ...
   public class GameInSocketOut
   {
      ...
      {
         var _loc1_:PackageOut = new PackageOut(ePackageType.GAME_INVITE);
         _loc1_.writeInt(0);
         sendPackage(_loc1_);
      }
      ...
      public static function sendGameCMDShoot(param1:int, param2:int, param3:int, param4:int, param5:int = 0, param6:Boolean = false) : void
      {
         var _loc7_:PackageOut = new PackageOut(ePackageType.GAME_CMD);
         _loc7_.writeByte(CrazyTankPackageType.FIRE);
         _loc7_.writeInt(param5);
         _loc7_.writeInt(int(param1));
         _loc7_.writeInt(int(param2));
         _loc7_.writeInt(int(param3));
         _loc7_.writeInt(int(param4));
      ...
      public static function sendMissionTryAgain(param1:int, param2:Boolean) : void
      {
         var _loc3_:PackageOut = new PackageOut(ePackageType.GAME_CMD);
         _loc3_.writeByte(CrazyTankPackageType.GAME_MISSION_TRY_AGAIN);
         _loc3_.writeInt(param1);
         _loc3_.writeBoolean(param2);
         sendPackage(_loc3_);
      }
