package quest
{
   ...
   public class QuestBubbleMode
   {
      ...
      public function get questsInfo() : Array
      {
         ...
         {
            if(_loc1_[_loc3_].Type < 2)
            {
               _loc2_.push(_loc1_[_loc3_]);
            }
            _loc3_++;
         }
         return this._reseachComplete(_loc2_);
      }
      ...
      private function _setTxtInArr() : Array
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < this._questInfoArr.length)
         {
            _loc3_ = 0;
            ...
            if(QuestInfo(this._questInfoArr[_loc2_]).isCompleted)
            {
               ...
               _loc7_.txtII = "<font COLOR=\'#8be961\'>" + this._analysisStrII(this._analysisStrIII(QuestInfo(this._questInfoArr[_loc2_]))) + "</font>";
