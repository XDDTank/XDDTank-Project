package bead.view
{
   ...
   public class BeadScoreShopFrame extends Frame
   {
      ...
      private function gotoPageHandler(param1:MouseEvent) : void
      {
         ...
         switch(_loc2_)
         {
            ...
            case this._leftPageTurnBtn:
               --this._curPage;
               this._curPage = this._curPage < 1 ? int(this._totalPage) : int(this._curPage);
               break;
            case this._rightPageTurnBtn:
               ++this._curPage;
               this._curPage = this._curPage > this._totalPage ? int(1) : int(this._curPage);
               break;
      ...
      private function returnHandler(param1:MouseEvent) : void
      {
         SoundManager.instance.play("008");
         this.closeThis();
      }
      ...
      private function refreshScore(param1:PlayerPropertyEvent) : void
      {
