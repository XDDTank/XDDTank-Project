package bagAndInfo.cell
{
   ...
   public class CellFactory implements ICellFactory
   {
      ...
      public function createLockBagCell(param1:int, param2:ItemTemplateInfo = null, param3:Boolean = true) : ICell
      {
         var _loc4_:LockBagCell = new LockBagCell(param1,param2,param3);
         this.fillTipProp(_loc4_);
         return _loc4_;
      }
      
      public function createAuctionBagCell(param1:int, param2:ItemTemplateInfo = null, param3:Boolean = true) : ICell
      {
         var _loc4_:AuctionBagCell = new AuctionBagCell(param1,param2,param3);
         this.fillTipProp(_loc4_);
         return _loc4_;
      }
