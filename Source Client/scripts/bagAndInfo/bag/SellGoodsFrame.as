package bagAndInfo.bag
{
   ...
   public class SellGoodsFrame extends Frame
   {
      ...
      public function set itemInfo(param1:InventoryItemInfo) : void
      {
         ...
         if(param1.CategoryID == EquipType.EQUIP || param1.CategoryID == EquipType.COMPOSE_MATERIAL || param1.CategoryID == EquipType.COMPOSE_SKILL)
         {
            this._nameTxt.textColor = QualityType.EQUIP_QUALITY_COLOR[param1.Quality];
         }
         else
         {
         ...
         this._descript.text = LanguageMgr.GetTranslation("bagAndInfo.sellFrame.explainTxtI") + "           " + _loc2_;
         this._num.text = String(param1.Count);
