package arena.view
{
   ...
   public class ArenaReliveView extends Frame
   {
      ...
      public function ArenaReliveView()
      {
         super();
      }
      ...
      {
         return Boolean(parent) ? Boolean(true) : Boolean(false);
      }
      ...
      private function __everySeconds(param1:TimeEvents) : void
      {
         --this._tick;
         if(this._timeTxt)
         {
      ...
      private function __reliveHere(param1:MouseEvent) : void
      {
         SoundManager.instance.play("008");
      ...
      private function __reliveSafety(param1:MouseEvent) : void
      {
         SoundManager.instance.play("008");
         ArenaManager.instance.sendRelive(1);
         this.hide();
