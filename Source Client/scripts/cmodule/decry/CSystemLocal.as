package cmodule.decry
{
   ...
   public class CSystemLocal implements CSystem
   {
      ...
      public function CSystemLocal(param1:Boolean = false)
      {
         ...
         gtextField.width = Boolean(gsprite) ? Number(gsprite.stage.stageWidth) : Number(800);
         gtextField.height = Boolean(gsprite) ? Number(gsprite.stage.stageHeight) : Number(600);
      ...
      {
         var _loc4_:String = gstate.gworker.stringFromPtr(param1);
         if(param2 != 0)
         {
      ...
      {
         var _loc2_:String = gstate.gworker.stringFromPtr(param1);
      ...
      {
         var _loc3_:String = gstate.gworker.stringFromPtr(param1);
         if(param2 & ~4)
         {
