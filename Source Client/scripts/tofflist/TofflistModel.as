package tofflist
{
   ...
   public class TofflistModel
   {
      ...
      private var _militaryLocalTopTen:DictionaryData;
      
      public var rankInfo:RankInfo;
      
      public function TofflistModel()
      {
         this._militaryLocalTopTen = new DictionaryData();
         super();
      }
      ...
      public function set Person_local_military(param1:TofflistListData) : void
      {
         this._person_local_military = param1;
      ...
      public function set Person_cross_military(param1:TofflistListData) : void
      {
         this._person_cross_military = param1;
      ...
      public function set arenaLocalScoreDay(param1:TofflistListData) : void
      {
         this._arenaLocalScoreDay = param1;
      ...
      public function set arenaLocalScoreWeek(param1:TofflistListData) : void
      {
         this._arenaLocalScoreWeek = param1;
      ...
      public function set arenaCrossScoreDay(param1:TofflistListData) : void
      {
         this._arenaCrossScoreDay = param1;
      ...
      public function set arenaCrossScoreWeek(param1:TofflistListData) : void
      {
         this._arenaCrossScoreWeek = param1;
      ...
      public function personalResult(param1:TofflistListTwoAnalyzer) : void
      {
         TofflistModel.Instance[param1.listName] = param1.data;
      }
      
      public function sociatyResult(param1:TofflistListAnalyzer) : void
      {
         TofflistModel.Instance[param1.listName] = param1.data;
      }
      
      public function getMilitaryLocalTopN(param1:int = 3) : DictionaryData
      {
         var _loc2_:int = 0;
         ...
         if(this._militaryLocalTopTen.length <= 0)
         {
            if(this.Person_local_military.list.length > 0)
            {
               ...
               while(_loc2_ < param1)
               {
                  if(this.Person_local_military.list[_loc2_].RankScores <= ServerConfigManager.instance.getMilitaryData()[12])
                  {
                     break;
                  }
                  _loc3_ = [];
                  _loc3_.push(_loc2_ + 1);
                  _loc3_.push(this.Person_local_military.list[_loc2_]);
                  this._militaryLocalTopTen.add(this.Person_local_military.list[_loc2_].ID,_loc3_);
                  _loc2_++;
               }
            }
         }
      ...
      public function loadRankInfo() : void
      {
         ...
         var _loc2_:BaseLoader = LoadResourceManager.instance.createLoader(PathManager.solveRequestPath("UserRankDate.ashx"),BaseLoader.REQUEST_LOADER,_loc1_);
