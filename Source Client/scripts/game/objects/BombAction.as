package game.objects
{
   ...
   public class BombAction
   {
      ...
      public function BombAction(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int)
      {
         super();
         this._time = param1;
         this._type = param2;
      ...
      public function execute(param1:SimpleBomb, param2:GameInfo) : void
      {
         ...
         switch(this._type)
         {
            ...
            case ActionType.BOMB:
               ...
               param1.bomb();
               if(param1.info && param1.info.isSelf)
               {
            ...
            case ActionType.KILL_PLAYER:
               ...
               if(_loc5_)
               {
                  ...
                  _loc5_.updateBlood(this._param4,this._param3,0 - this._param2,this.index);
            ...
            case ActionType.CHANGE_SPEED:
               ...
               if(this._param3 >= 0)
               {
                  ...
                  if(_loc19_)
                  {
                     _loc19_.showEffect("asset.game.propanimation.guild");
                  }
               }
               break;
            ...
            case ActionType.CURE:
               ...
               if(_loc9_)
               {
                  ...
                  _loc9_.updateBlood(this._param2,0,this._param3,this.index);
               }
               break;
