package game.objects
{
   ...
   public class GameSmallEnemy extends GameLiving
   {
      ...
      override public function collidedByObject(param1:PhysicalObj) : void
      {
         ...
         {
            if((param1 as SimpleBomb).info.Template.ID != 3)
            {
               info.isHidden = false;
            }
         }
      ...
      override public function needFocus(param1:int = 0, param2:int = 0, param3:Object = null, param4:Boolean = false) : void
      {
         map.livingSetCenter(x + param1,y + param2 - 150,param4,AnimationLevel.HIGHT,AnimationSet.PUBLIC_OWNER,param3);
      }
      
      override public function followFocus(param1:int = 0, param2:int = 0, param3:Object = null, param4:Boolean = false) : void
      {
         map.livingSetCenter(x + param1,y + param2 - 150,param4,AnimationLevel.HIGHT,AnimationSet.PUBLIC_OWNER,param3);
      }
   }
