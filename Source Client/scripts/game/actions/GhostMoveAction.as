package game.actions
{
   ...
   public class GhostMoveAction extends BaseAction
   {
      ...
      public function GhostMoveAction(param1:GameTurnedLiving, param2:Point, param3:Array = null)
      {
         super();
         this._target = param2;
         this._player = param1;
      ...
      override public function execute() : void
      {
         ...
         if(Point.distance(this._startPos,this._target) > this._vp.length)
         {
            ...
            else if(this._player is BossLocalPlayer)
            {
               (this._player as BossLocalPlayer).localPlayer.energy -= Math.round(Point.distance(_loc2_,_loc3_) / 1.5);
            }
         }
         else
         {
