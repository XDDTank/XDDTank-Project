package game.actions
{
   ...
   public class ChangeNpcAction extends BaseAction
   {
      ...
      public function ChangeNpcAction(param1:GameViewBase, param2:MapView, param3:Living, param4:CrazyTankSocketEvent, param5:PackageIn, param6:Boolean)
      {
         super();
      ...
      private function updateNpc() : void
      {
         ...
         {
            if(_loc1_.typeLiving != LivingTypesEnum.SIMPLE_NPC_NORMAL && _loc1_.typeLiving != LivingTypesEnum.AI_PLAYER && _loc1_.typeLiving != LivingTypesEnum.NORMAL_PLAYER && _loc1_.typeLiving != LivingTypesEnum.SENIOR_AI_PLAYER && !_loc1_.isBoss && _loc1_.blood <= 0)
            {
               _loc1_.dispose();
            }
            else
      ...
      private function getClosestEnemy() : SmallEnemy
      {
         ...
         {
            if(_loc4_ is SmallEnemy && _loc4_.isLiving && _loc4_.typeLiving != 3 && (!GameManager.Instance.isSingleDungeonRoom() || !this._map.getContains(_loc4_.pos.x,_loc4_.pos.y)))
            {
