package game.animations
{
   ...
   public class ShockingSetCenterAnimation extends BaseSetCenterAnimation
   {
      ...
      public function ShockingSetCenterAnimation(param1:Number, param2:Number, param3:int = 165, param4:Boolean = false, param5:int = 0, param6:int = 12, param7:int = -1)
      {
         super(param1,param2,param3,false,param5,param7,48);
