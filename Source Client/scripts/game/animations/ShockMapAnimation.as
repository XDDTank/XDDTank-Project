package game.animations
{
   ...
   public class ShockMapAnimation implements IAnimate
   {
      ...
      public function ShockMapAnimation(param1:PhysicalObj, param2:Number = 7, param3:Number = 0, param4:int = 2, param5:int = 10000)
      {
         var _loc6_:SimpleBomb = null;
         super();
         this._age = 0;
         this._life = param3;
         ...
         {
            _loc6_ = this._bomb as SimpleBomb;
            if(_loc6_.target && _loc6_.owner)
            {
               if(_loc6_.target.x - _loc6_.owner.pos.x < 0)
               {
                  this._scale = -1;
               }
            }
