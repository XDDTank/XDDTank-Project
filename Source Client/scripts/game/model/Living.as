package game.model
{
   ...
   public class Living extends EventDispatcher implements ICommandedAble
   {
      ...
      private function addPayBuff(param1:FightBuffInfo) : void
      {
         ...
         this._payBuff.addFightBuff(param1);
      }
      
      private function addConsortiaBuff(param1:int, param2:FightBuffInfo) : void
      {
         this._consortiaBuff = new FightContainerBuff(param1,BuffType.CONSORTIA);
         this._consortiaBuff.data = param2.data;
         this._consortiaBuff.displayid = param2.displayid;
         this._localBuffs.unshift(this._consortiaBuff);
         this._consortiaBuff.addFightBuff(param2);
      }
      ...
      private function addCardBuff(param1:FightBuffInfo) : void
      {
         ...
         this._cardBuff.addFightBuff(param1);
      }
      
      public function addBuff(param1:FightBuffInfo) : void
      {
         param1.isSelf = this.isSelf;
         if(BuffType.isConsortiaBuff(param1))
         {
            this.addConsortiaBuff(param1.displayid,param1);
            return;
         }
         ...
         if(BuffType.isCardBuff(param1))
         {
            this.addCardBuff(param1);
            return;
         }
         ...
         else if(param1.type == BuffType.ARENA_BUFF)
         {
            this._localBuffs.push(param1);
         }
         else
      ...
      public function removeBuff(param1:int) : void
      {
         ...
         var _loc3_:int = 0;
         if(BuffType.isLocalBuffByID(param1) || BuffType.isMilitaryBuff(param1))
         {
      ...
      public function set shootPos(param1:Point) : void
      {
         this._shootPos = param1;
      }
      ...
      public function set DieFightBuffEnabled(param1:Boolean) : void
      {
         if(this._dieFightBuffEnabled != param1)
         {
            this._dieFightBuffEnabled = param1;
      ...
      public function updateBlood(param1:int, param2:int, param3:int = 0, param4:int = -1) : void
      {
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         if(!this.isLiving)
         ...
         if(param2 == WOUND)
         {
            if(param4 == -1 || param4 > this._lastBombIndex)
            {
               this._blood = param1;
            }
            dispatchEvent(new LivingEvent(LivingEvent.BLOOD_CHANGED,param1,this._blood,param2,param3));
         }
         else if(param2 == FLASH_BACK)
         {
            _loc5_ = this._blood;
            this._blood -= param3;
            dispatchEvent(new LivingEvent(LivingEvent.BLOOD_CHANGED,this._blood,_loc5_,param2,param3));
         }
         else if(this._blood != param1 || GameManager.Instance.Current.gameMode == 17)
         {
            _loc6_ = this._blood;
            this.blood = param1;
            if(param2 != SUICIDE && this._isLiving)
            {
               dispatchEvent(new LivingEvent(LivingEvent.BLOOD_CHANGED,param1,_loc6_,param2,param3));
            }
         }
      ...
      public function explainType(param1:int) : void
      {
         this._fightToolBoxSkill = (1 << FIGHT_TOOL_SKILL - 1 & param1) != 0;
      }
      ...
      public function getHorizonDistance(param1:Living) : int
      {
         if(param1)
         {
            return Math.abs(this.pos.x - param1.pos.x);
         }
         return 0;
      }
      ...
      public function set isShoot(param1:Boolean) : void
      {
         this._isShoot = param1;
      }
      ...
      public function set lastBombIndex(param1:int) : void
      {
         this._lastBombIndex = param1;
      }
   }
}
