package game.model
{
   ...
   public class Player extends TurnedLiving
   {
      ...
      override public function updateBlood(param1:int, param2:int, param3:int = 0, param4:int = -1) : void
      {
      ...
      {
         var _loc3_:PetSkillInfo = PetSkillManager.instance.getSkillByID(param1);
         if(_loc3_ && param2)
         {
      ...
      public function petDefence(param1:String, param2:Point) : void
      {
         dispatchEvent(new LivingEvent(LivingEvent.PET_DEFENCE,0,0,param1,param2));
      }
      
      public function set actionMCname(param1:String) : void
      {
         this.actionMovieName = param1;
      }
