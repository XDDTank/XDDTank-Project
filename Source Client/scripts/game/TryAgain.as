package game
{
   ...
   public class TryAgain extends Sprite implements Disposeable
   {
      ...
      public function TryAgain(param1:MissionAgainInfo)
      {
      ...
      private function __tryagainClick(param1:MouseEvent) : void
      {
         if(param1)
         {
         ...
         if(RoomManager.Instance.current.selfRoomPlayer.isHost)
         {
            ...
            else if(!this._info.hasLevelAgain && this._info.value > PlayerManager.Instance.Self.totalMoney)
            {
               LeavePageManager.showFillFrame();
               return;
            }
