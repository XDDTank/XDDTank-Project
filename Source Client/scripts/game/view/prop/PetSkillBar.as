package game.view.prop
{
   ...
   public class PetSkillBar extends FightPropBar
   {
      ...
      protected var _skillCells:Vector.<PetSkillCell>;
      ...
      override protected function __keyDown(param1:KeyboardEvent) : void
      {
         ...
         {
            if(_loc4_.shortcutKey == _loc3_ && _loc4_.skillInfo.isActiveSkill && _loc4_.isEnabled && _loc4_.enabled)
            {
               _loc4_.useProp();
               break;
            }
      ...
      override protected function drawCells() : void
      {
         ...
         if(_self.currentPet)
         {
            ...
            while(_loc3_ < this.letters.length)
            {
               ...
               {
                  _loc6_ = PetSkillManager.instance.getSkillByID(_loc5_);
