package game.view
{
   ...
   public class VaneView extends Sprite
   {
      ...
      public function update(param1:Number, param2:Boolean = false, param3:Array = null) : void
      {
         ...
         if(param1 != 0)
         {
            this._bmVaneTitle.x = param3[0] == true ? Number(this._vaneTitlePos2.x) : Number(this._vaneTitlePos.x);
         }
      ...
      {
         var _loc1_:Number = this.getRandomVaneOffset();
      ...
      private function lastTurn(param1:Number) : void
      {
         ...
         this._bmPreviousDirection.x = param1 > 0 ? Number(this._previousDirectionPos.x) : Number(this._previousDirectionPos.x + this._bmPreviousDirection.width);
