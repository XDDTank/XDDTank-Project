package game.view.experience
{
   ...
   public class ExpView extends Sprite implements Disposeable
   {
      ...
      public function show() : void
      {
         ...
         var _loc1_:Object = this._expObj = this._gameInfo.selfGamePlayer.expObj;
         if(_loc1_ && _loc1_.hasOwnProperty("luckyExp") && _loc1_.luckyExp > 0)
         {
            this._luckyExp = true;
         }
         if(_loc1_ && _loc1_.hasOwnProperty("luckyOffer") && _loc1_.luckyOffer > 0)
         {
            this._luckyOffer = true;
         }
         switch(_loc1_.gameOverType)
         {
            ...
            case GAME_OVER_TYPE_1:
               ...
               this._fightNums = [_loc1_.baseExp];
               this._attatchNums = [_loc1_.gpForVIP,0,_loc1_.gpForConsortia,_loc1_.gpForSpouse,_loc1_.gpForServer,_loc1_.gpForApprenticeOnline,_loc1_.gpForApprenticeTeam,_loc1_.gpForDoubleCard,_loc1_.gpForPower,_loc1_.consortiaSkill];
               this._exploitNums = [_loc1_.offerFight,_loc1_.offerDoubleCard,_loc1_.offerVIP,_loc1_.offerService,_loc1_.offerBuff,_loc1_.offerConsortia];
               this.setDefyInfo();
               break;
            ...
            case GAME_OVER_TYPE_4:
               SoundManager.instance.play(!!this._gameInfo.selfGamePlayer.isWin ? "063" : "064");
               this._fightNums = [_loc1_.baseExp];
               this._attatchNums = [_loc1_.gpForVIP,0,_loc1_.gpForSpouse,_loc1_.gpForServer,_loc1_.gpForApprenticeOnline,_loc1_.gpForApprenticeTeam,_loc1_.gpForDoubleCard,_loc1_.consortiaSkill];
               break;
