package game.view.playerThumbnail
{
   ...
   public class PlayerThumbnailList extends Sprite implements Disposeable
   {
      ...
      public function PlayerThumbnailList(param1:DictionaryData, param2:int = 1, param3:Boolean = true)
      {
         super();
         this._dirct = param2;
         this._info = param1;
      ...
      private function initView() : void
      {
         ...
         if(this._info)
         {
            ...
            {
               _loc3_ = new PlayerThumbnail(this._info[_loc2_],this._dirct,this._isConsortionType);
