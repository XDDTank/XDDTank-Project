package game.view.smallMap
{
   ...
   public class SmallMapView extends Sprite implements Disposeable
   {
      ...
      private function __onEnterFrame(param1:Event) : void
      {
         ...
         {
            this._screen.y = this._screen.y;
            this._screen.x = this._screen.x < 0 ? Number(0) : Number(this._screen.x);
            ...
            this._map.animateSet.addAnimation(new DragMapAnimation(_loc2_,_loc3_,true,100,AnimationLevel.HIGHEST,AnimationSet.PUBLIC_OWNER));
            if(this._split)
            {
      ...
      private function __click(param1:MouseEvent) : void
      {
         if(this._allowDrag)
         {
            this._map.animateSet.addAnimation(new DragMapAnimation(param1.localX / this._drawMatrix.a,param1.localY / this._drawMatrix.d,false,100,AnimationLevel.HIGHEST,AnimationSet.PUBLIC_OWNER));
         }
      }
      ...
      public function moveToPlayer() : void
      {
         ...
         this._map.animateSet.addAnimation(new DragMapAnimation(_loc2_,_loc3_,true,100,AnimationLevel.HIGHER,AnimationSet.PUBLIC_OWNER));
      }
      ...
      public function drawRouteLine(param1:int) : void
      {
         ...
         this._collideRect.x = _loc5_.pos.x * this._drawMatrix.a - 50 * this._drawMatrix.a;
         this._collideRect.y = _loc5_.pos.y * this._drawMatrix.d - 50 * this._drawMatrix.d;
      ...
      private function drawDashed(param1:Graphics, param2:Point, param3:Point, param4:Number, param5:Number) : void
      {
         ...
         var _loc6_:Number = param2.x * this._drawMatrix.a;
         var _loc7_:Number = param2.y * this._drawMatrix.d;
         var _loc8_:Number = Math.atan2(param3.y * this._drawMatrix.d - _loc7_,param3.x * this._drawMatrix.a - _loc6_);
