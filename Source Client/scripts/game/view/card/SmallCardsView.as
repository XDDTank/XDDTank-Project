package game.view.card
{
   ...
   public class SmallCardsView extends Sprite implements Disposeable
   {
      ...
      protected function createCards() : void
      {
         ...
         var _loc1_:Point = new Point(26,15);
         var _loc2_:int = 0;
         while(_loc2_ < this._cardCnt)
         {
            ...
            _loc3_.x = _loc2_ % this._cardColumns * (_loc1_.x + _loc4_.width) + 80;
            _loc3_.y = int(_loc2_ / this._cardColumns) * (_loc1_.y + _loc4_.height) + 38;
            _loc4_.x = _loc1_.x + _loc4_.width + 80;
            _loc4_.y = _loc1_.y + _loc4_.height + 38;
