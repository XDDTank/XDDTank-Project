package game.view.card
{
   ...
   public class TakeOutCardController extends EventDispatcher implements Disposeable
   {
      ...
      public function setState() : void
      {
         ...
         else if(this._roomInfo.type == RoomInfo.MATCH_ROOM)
         {
         ...
         else if((this._roomInfo.type == RoomInfo.DUNGEON_ROOM || this._roomInfo.type == RoomInfo.MULTI_DUNGEON) && this._gameInfo.hasNextMission)
         {
