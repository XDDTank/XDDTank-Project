package room.view.bigMapInfoPanel
{
   ...
   public class DropList extends Sprite implements Disposeable
   {
      ...
      public function set info(param1:Array) : void
      {
         ...
         var _loc2_:Rectangle = ComponentFactory.Instance.creatCustomObject("asset.ddtroom.dropList.cellRect");
         for each(_loc3_ in param1)
         {
            _loc5_ = ItemManager.Instance.getTemplateById(_loc3_);
            _loc6_ = new BaseCell(ComponentFactory.Instance.creatComponentByStylename("asset.ddtroom.dropCellBgAsset"),_loc5_);
            _loc6_.overBg = ComponentFactory.Instance.creatBitmap("asset.ddtroom.dropCellOverBgAsset");
