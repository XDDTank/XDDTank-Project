...
namespace SqlDataProvider.Data
{
    ...
    {
        public int BadgeType { get; set; }//public var BadgeType:int;
        public string BadgeName { get; set; }//public var BadgeName:String;
        public int BadgeID { get; set; }//private var _badgeID:int = 0;
        public string BadgeBuyTime { get; set; }//private var _badgeBuyTime:String;
        public int ValidDate { get; set; }//private var _validDate:int;
        public bool IsVoting { get; set; }//private var _IsVoting:Boolean;
        public int VoteRemainDay { get; set; }//public var VoteRemainDay:int;
