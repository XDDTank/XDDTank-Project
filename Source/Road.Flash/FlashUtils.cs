...
namespace Road.Flash
{
    public class FlashUtils
    {
        ...
        {
            string key = "//////////9v/////////wAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=";
               return new XElement("Item", new XAttribute("ID", info.ID),
               ...
               new XAttribute("RecruitState",key));
        }
        ...
        public static XElement CreateConsortiaInfo(ConsortiaInfo info)
        {
            return new XElement("Item", 
                ...
                new XAttribute("BadgeID", info.BadgeID),//BadgeID="0" 
                new XAttribute("BadgeBuyTime",Convert.ToDateTime(info.BadgeBuyTime).ToString("yyyy-MM-dd HH:mm:ss")),//BadgeBuyTime="2012-08-16 16:30:30" 
                new XAttribute("ValidDate", info.ValidDate));//ValidDate="0"
