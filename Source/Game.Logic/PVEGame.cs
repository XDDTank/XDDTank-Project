        ...
        */
        public void GameOver()
        {
            if (GameState == eGameState.Playing)
            {
                ...
                foreach (Player p in players)
                {
                    ...
                    pkg.WriteBoolean(false);//_loc_8.hasLevelAgain = _loc_2.readBoolean();
                    pkg.WriteBoolean(false);//_loc_8.hasGardGet = _loc_2.readBoolean();
                }
        ...
        public void GameOverAllSession()
        {
            ...
            if (GameState == eGameState.GameOver)
            {
                ...
                foreach (Player p in players)
                {
                    ...
                    pkg.WriteInt(p.TotalAllScore);//_loc_7.hertGP = _loc_2.readInt();
                    pkg.WriteInt(p.TotalAllCure);//_loc_7.ghostGP = _loc_2.readInt();
                    pkg.WriteInt(0);//_loc_7.gpForVIP = _loc_2.readInt();
                    pkg.WriteInt(0);//_loc_7.gpForSpouse = _loc_2.readInt();
                    pkg.WriteInt(0);//_loc_7.gpForServer = _loc_2.readInt();
                    pkg.WriteInt(0);//_loc_7.gpForApprenticeOnline = _loc_2.readInt();
                    pkg.WriteInt(0);//_loc_7.gpForApprenticeTeam = _loc_2.readInt();
                    pkg.WriteInt(0);//_loc_7.gpForDoubleCard = _loc_2.readInt();
                    pkg.WriteInt(0);//_loc_7.consortiaSkill = _loc_2.readInt();
                    pkg.WriteInt(0);//_loc_7.luckyExp = _loc_2.readInt();        
                    pkg.WriteInt(p.TotalAllExperience);//_loc_7.gainGP = _loc_2.readInt()
                    pkg.WriteBoolean(IsWin);
        ...
        internal void SendShowCards()
        {
            ...
            foreach (int index in cardIndexs)
            {
                ...
                List<ItemInfo> infos = DropInventory.CopySystemDrop(m_missionInfo.Id, cardIndexs.Count);
                if (infos != null)
                {
                    foreach (ItemInfo info in infos)
                    {
        ...
        private void SendCreateGameToSingle(PVEGame game, IGamePlayer gamePlayer)
        {
            ...
            foreach (Player p in players)
            {
                ...
                pkg.WriteInt(gp.PlayerCharacter.badgeID);//_loc_8.badgeID = _loc_2.readInt();
            ...
            pkg.WriteString("show" + game.SessionId + ".jpg");
