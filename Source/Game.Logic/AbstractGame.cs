...
namespace Game.Logic
{
    public enum eRoomType
    {
        ...
        Lanbyrinth = 15,//15,//LANBYRINTH_ROOM:int = 15; ADVANCED_DUNGEON_ROOM:int = 15;
        Encounter = 16,//ENCOUNTER_ROOM:int = 16;
        FightGround = 18,//FIGHTGROUND_ROOM:int = 18;
        ConsortiaBoss = 17,//CONSORTIA_BOSS:int = 17;
    }
