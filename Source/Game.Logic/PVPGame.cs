...
namespace Game.Logic
{
    public class PVPGame : BaseGame
    {
            ...
            : base(id, roomId, map, roomType, gameType, timeType)
        {
            ...
            {
                Player fp = new Player(player, PhysicalId++, this, 2, player.PlayerCharacter.hp);
            ...
            if (DropInventory.CardDrop(RoomType, ref  infos))
            {
                if (infos != null)
                {
                    foreach (ItemInfo info in infos)
                    {
                        ...
                        if (gold + money + giftToken + medal == 0)
                        {
        ...
        public void GameOver()
        {
            if (GameState == eGameState.Playing)
            {
                ...
                foreach (Player p in players)
                {
                        ...
                        p.GainOffer = p.PlayerDetail.AddOffer(riches);
                        ...
                        pkg.WriteInt(0);//gpForVIP = _loc_2.readInt();
                        pkg.WriteInt(0);//gpForConsortia = _loc_2.readInt();
                        pkg.WriteInt(0);//gpForSpouse = _loc_2.readInt();
                        pkg.WriteInt(0);//gpForServer = _loc_2.readInt();
                        pkg.WriteInt(0);//gpForApprenticeOnline = _loc_2.readInt();
                        pkg.WriteInt(0);//gpForApprenticeTeam = _loc_2.readInt();
                        pkg.WriteInt(0);//gpForDoubleCard = _loc_2.readInt();
                        pkg.WriteInt(0);//gpForPower = _loc_2.readInt();
                        pkg.WriteInt(0);//consortiaSkill = _loc_2.readInt();
                        pkg.WriteInt(0);//luckyExp = _loc_2.readInt();
                        pkg.WriteInt(p.GainGP);
                        pkg.WriteInt(0);//offerFight = _loc_2.readInt();
                        pkg.WriteInt(0);//offerDoubleCard = _loc_2.readInt();
                        pkg.WriteInt(0);//offerVIP = _loc_2.readInt();
                        pkg.WriteInt(0);//offerService = _loc_2.readInt();
                        pkg.WriteInt(0);//offerBuff = _loc_2.readInt();
                        pkg.WriteInt(0);//offerConsortia = _loc_2.readInt();
                        pkg.WriteInt(0);//luckyOffer = _loc_2.readInt();
