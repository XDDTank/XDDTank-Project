...
namespace Game.Logic
{
    public static class PveInfoMgr
    {
        ...
        {
            //if (roomType == eRoomType.Dungeon || roomType == eRoomType.Freshman)
            if (roomType == eRoomType.Dungeon || roomType == eRoomType.Freshman
                    || roomType == eRoomType.Lanbyrinth || roomType == eRoomType.ConsortiaBoss
                    || roomType == eRoomType.AcademyDungeon || roomType == eRoomType.FightLib)
            {
