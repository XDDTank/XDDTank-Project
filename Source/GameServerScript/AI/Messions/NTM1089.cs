...
namespace GameServerScript.AI.Messions
{
    ...
    {       
        ...
        public override void OnStartGame()
        {
            ...
            int Y= birthX[0];
            someNpc.Add(Game.CreateNpc(npcID, 52, Y, -1));
            //index = Game.Random.Next(0, birthY.Length);
            //Y = birthX[index];
            someNpc.Add(Game.CreateNpc(npcID, 100, Y, -1));            

            //Right born
            // index = Game.Random.Next(0, birthY.Length);
            //Y = birthX[index];
            someNpc.Add(Game.CreateNpc(npcID, 1120, Y, 1));
            //index = Game.Random.Next(0, birthY.Length);
            //Y = birthX[index];
            someNpc.Add(Game.CreateNpc(npcID, 1155, Y, 1));
                ...
                if (Game.GetLivedLivings().Count < 4)
                {
                    for (int i = 0; i < 4 - Game.GetLivedLivings().Count; i++)
                    {
                        ...
                        else
                        {
                            ...
                            someNpc.Add(Game.CreateNpc(npcID, NpcX, birthY[0], dis));
