...
namespace GameServerScript.AI.Messions
{
    public class NTM1088 : AMissionControl
    {
        ...
        public override void OnNewTurnStarted()
        {
            if ( m_effect == null)
            {
                m_effect = Game.Createlayer(1150, 510, "moive", "asset.game.0.guangquan", "in", 1, 0);
            }
        }
        ...
        public override void OnBeginNewTurn()
        {
            ...
            if (target.X > 1050)
            {
                m_effect.PlayMovie("standA", 10000, 0);
                if (isAddBlood)
                {
            ...
            {
                m_effect.PlayMovie("standB", 10000, 0);
            }
        }
        ...
        {            
            simpleNpcList.Add(Game.CreateNpc(redNpcID, 1110, 520, 1));
        }
    }
}
