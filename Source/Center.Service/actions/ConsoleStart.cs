...
namespace Game.Service.actions
{
    ...
    public class ConsoleStart:IAction
    {
        ...
        {
            Console.WriteLine("Starting Center Server ! Please wait ...");
        ...
        {
            Console.WriteLine("XDDTank Server by Meocon5000");
                ...
                try
                {
                    ...
                    switch (para[0].ToLower())
                    {
                        ...
                        case "notice":
                            if (para.Length < 2)
                            {
                                Console.WriteLine("At least 2 character to send notice!");
                            }
                            else
                            {
