            ...
            if (m_saveToDb)
            {
                using (PlayerBussiness pb = new PlayerBussiness())
                {
                    ...
                    try
                    {
                        ...
                        {
                            //TimeSpan usedTime = DateTime.Now - item.goldBeginTime.Date;
                            //if (usedTime.Days > item.goldValidDate && item.StrengthenLevel == 13)                            
                            //{
                            //    int TemplateID = item.TemplateID;
                            //     item.IsGold = false;
                            //    item.goldValidDate = 0;
                            ...
                            //        item.TemplateID = goldEquip.OldTemplateId;
                            //        item.Template = ItemMgr.FindItemTemplate(goldEquip.OldTemplateId);
                            //    }
