...
namespace Game.Server.Packets.Client
{
    ...
    public class ItemTransferHandler : IPacketHandler
    {
        ...
        public int HandlePacket(GameClient client, GSPacketIn packet)
        {
            ...
            ItemInfo transferBefore = client.Player.StoreBag.GetItemAt(0);
            ItemInfo transferAfter = client.Player.StoreBag.GetItemAt(1);           
            //未开始
                ...
                transferBefore.IsValidItem() && transferAfter.IsValidItem())
            {
                ...
                if (client.Player.PlayerCharacter.Gold < mustGold)
                {
                    ...
                    if (transferBefore.Template.CategoryID == 7 || transferAfter.Template.CategoryID == 7)
                    {
                        ...
                        newTemp0 = ItemMgr.FindItemTemplate(_temID0);
                        newTemp1 = ItemMgr.FindItemTemplate(_temID1);
                        if (newTemp0 != null)
                    ...
                    client.Player.StoreBag.AddItemTo(transferBefore, 0);
                    client.Player.StoreBag.AddItemTo(transferAfter, 1);
