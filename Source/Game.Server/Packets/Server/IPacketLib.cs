...
namespace Game.Base.Packets
{
    public interface IPacketLib
    {
        ...
        #endregion
        void SendOpenNewChickenBox(GamePlayer player);
        void SendDiceSystemOpen();
        void SendOpenWorldBoss();
        GSPacketIn SendConsortiaOpenBoss();
        void SendOpenRoulett();
        void SendOpenDragonBoat(PlayerInfo info);
        ...
        void SendEnterConsortia(PlayerInfo player);
   ...
   //     GSPacketIn SendContinuation = new GSPacketIn(GamePlayer player, HotSpringRoomInfo hotspringroominfo);
