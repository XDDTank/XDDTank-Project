    ...
    public class StartGameAction : IAction
    {
        ...
        public void Execute()
        {
            if (m_room.CanStart())
            {
                ...
                else if (m_room.RoomType == eRoomType.Dungeon || m_room.RoomType == eRoomType.Freshman
                    || m_room.RoomType == eRoomType.Lanbyrinth || m_room.RoomType == eRoomType.ConsortiaBoss || m_room.RoomType == eRoomType.WordBoss||
                     m_room.RoomType == eRoomType.AcademyDungeon || m_room.RoomType == eRoomType.FightLib)

                {
                    ...
                    m_room.BaseGames = GameMgr.StartPVEGame(m_room.RoomId, matchPlayers, m_room.MapId, m_room.RoomType, m_room.GameType, m_room.TimeMode, m_room.HardLevel, m_room.LevelLimits);
                    StartGame(m_room.m_baseGames);
                ...
                else if (m_room.RoomType == eRoomType.Match)
                {
                   ...
                   // m_room.GameType = eGameType.Guild;
                    ...
                    {
                        GSPacketIn pkg = m_room.Host.Out.SendMessage(eMessageType.ChatERROR, "Game đã bắt đầu!");
        ...
        {
            if (m_room.RoomType == eRoomType.Dungeon)
            {
