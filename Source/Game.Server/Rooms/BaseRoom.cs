...
namespace Game.Server.Rooms
{
    public class BaseRoom
    {
        ...
        public BaseGame BaseGames
        {
            get { return m_baseGames; }
            set { m_baseGames = value; }
        }
        ...
        public void UpdateRoomGameType()
        {
            switch (RoomType)
            {
                ...
                case eRoomType.Lanbyrinth:
                    GameType = eGameType.Lanbyrinth;//meocon5000
                    break;
                ...
                case eRoomType.Match:
                    ...
                    break;
                case eRoomType.WordBoss:
                    GameType = eGameType.WordBoss;
                    break;
                default:
        ...
        public bool AddPlayerUnsafe(GamePlayer player)
        {
            ...
            if (index != -1)
            {
                UpdatePosUnsafe(8, false, 0, -100);
                UpdatePosUnsafe(9, false, 0, -100);
