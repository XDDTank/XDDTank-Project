...
namespace Game.Server.Managers
{
    public class StrengthenMgr
    {
        ...
        public static void InheritTransferProperty(ref ItemInfo item0, ref ItemInfo item1, bool tranHole, bool tranHoleFivSix)
        {
            ...
            int _item0StrengthenExp = item0.StrengthenExp;
            bool _item0IsGold = item0.IsGold;
            int _item0goldValidDate = item0.goldValidDate;
            DateTime _item0goldBeginTime = item0.goldBeginTime;
            string _item0latentEnergyCurStr = item0.latentEnergyCurStr;
            string _item0latentEnergyNewStr = item0.latentEnergyNewStr;
            DateTime _item0latentEnergyEndTime = item0.latentEnergyEndTime;
            ...
            int _item1StrengthenExp = item1.StrengthenExp;
            bool _item1IsGold = item1.IsGold;
            int _item1goldValidDate = item1.goldValidDate;
            DateTime _item1goldBeginTime = item1.goldBeginTime;
            string _item1latentEnergyCurStr = item1.latentEnergyCurStr;
            string _item1latentEnergyNewStr = item1.latentEnergyNewStr;
            DateTime _item1latentEnergyEndTime = item1.latentEnergyEndTime;
            ...
            item0.StrengthenExp = _item1StrengthenExp;
            item1.StrengthenExp = _item0StrengthenExp;
            ...
            item0.IsGold = _item1IsGold;
            item1.IsGold = _item0IsGold;
            item0.goldBeginTime = _item1goldBeginTime;
            item1.goldBeginTime = _item0goldBeginTime;
            item0.goldValidDate = _item1goldValidDate;
            item1.goldValidDate = _item0goldValidDate;

            item0.latentEnergyCurStr = _item1latentEnergyCurStr;
            item1.latentEnergyCurStr = _item0latentEnergyCurStr;

            item0.latentEnergyNewStr = _item1latentEnergyNewStr;
            item1.latentEnergyNewStr = _item0latentEnergyNewStr;

            item0.latentEnergyEndTime = _item1latentEnergyEndTime;
            item1.latentEnergyEndTime = _item0latentEnergyEndTime;
        }
    }
}
