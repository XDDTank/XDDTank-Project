...
namespace Game.Server.Packets.Client
{
    ...
    public class UserChangeItemPlaceHandler : IPacketHandler
    {
        public int HandlePacket(GameClient client, GSPacketIn packet)
        {
            ...
            //Console.WriteLine("--bageType: " + bagType + " |place: " + place);
            //Console.WriteLine("--toBagType: " + toBagType + " |toPlace: " + toPlace);
            //Console.WriteLine("--count: " + count + " |isCount: " + isCount);
            if (count == -1)
            {
                return 0;
            }
            ...
            try
            {
                ...
                if (toPlace == -1)
                {
                    ...
                    {
                        Console.WriteLine("TakeOutItemEquip!");
                ...
                {
                    Console.WriteLine("Move same Bag!");
                ...
                else if (bagType == eBageType.Store)
                {
                    ...
                    Console.WriteLine("Move from Store!");
                }
                ...
                {
                    Console.WriteLine("Move from CaddyBag!");
                }
                ...
                {
                    bag.TakeOutItem(item);
                    Console.WriteLine("AddItemTo: " + toBag.BagType);
                }
            }
            finally
            {
