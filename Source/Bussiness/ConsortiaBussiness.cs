    ...
    public class ConsortiaBussiness : BaseBussiness
    {
        ...
        public bool BuyBadge(int consortiaID, int userID, ConsortiaInfo info, ref string msg)
        {
            ...
            try
            {
                ...
                para[0] = new SqlParameter("@ConsortiaID", consortiaID);
                para[1] = new SqlParameter("@UserID", userID);
                para[2] = new SqlParameter("@BadgeID", info.BadgeID);
                para[3] = new SqlParameter("@ValidDate", info.ValidDate);
                para[4] = new SqlParameter("@BadgeBuyTime", info.BadgeBuyTime);
                para[5] = new SqlParameter("@Result", SqlDbType.Int);
                para[5].Direction = ParameterDirection.ReturnValue;
                result = db.RunProcedure("SP_ConsortiaBadge_Update", para);
        ...
        public bool UpGradeSkillConsortia(int consortiaID, int userID, ref string msg)
        {
            ...
            try
            {
                ...
                para[2] = new SqlParameter("@Result", System.Data.SqlDbType.Int);
                para[2].Direction = ParameterDirection.ReturnValue;
                db.RunProcedure("SP_Consortia_Skill_UpGrade", para);
                int returnValue = (int)para[2].Value;
                result = returnValue == 0;
                switch (returnValue)
                {
        ...
        public ConsortiaApplyUserInfo[] GetConsortiaApplyUserPage(int page, int size, ref int total, int order, int consortiaID, int applyID, int userID)
        {
            ...
            try
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    info.IsOld = (bool)dr["IsOldPlayer"];
