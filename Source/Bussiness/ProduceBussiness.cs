...
namespace Bussiness
{
    public class ProduceBussiness : BaseBussiness
    {
        ...
        {
            List<LoadUserBoxInfo> infos = new List<LoadUserBoxInfo>();
            SqlDataReader reader = null;
            try
            {
                db.GetReader(ref reader, "SP_TimeBox_Award_All");
                while (reader.Read())
                {
                    LoadUserBoxInfo info = new LoadUserBoxInfo();
        ...
        //GoldEquipTemplateLoadGold
        public GoldEquipTemplateLoadInfo[] GetAllGoldEquipTemplateLoad()
        {
            List<GoldEquipTemplateLoadInfo> infos = new List<GoldEquipTemplateLoadInfo>();
            SqlDataReader reader = null;
            try
            {
                db.GetReader(ref reader, "SP_GoldEquipTemplateLoad_All");
                while (reader.Read())
                {
                    infos.Add(InitGoldEquipTemplateLoad(reader));
                }
            }
            catch (Exception e)
            {
                if (log.IsErrorEnabled)
                    log.Error("GetAllGoldEquipTemplateLoad", e);
            }
            finally
            {
                if (reader != null && !reader.IsClosed)
        ...
        {
            GoldEquipTemplateLoadInfo info = new GoldEquipTemplateLoadInfo();
            info.ID = (int)reader["ID"];
            info.OldTemplateId = (int)reader["OldTemplateId"];
            info.NewTemplateId = (int)reader["NewTemplateId"];
            info.CategoryID = (int)reader["CategoryID"];
            info.Strengthen = (int)reader["Strengthen"];
            ...
            info.Boold = (int)reader["Boold"];
            info.BlessID = (int)reader["BlessID"];
            info.Pic = (string)reader["pic"] == null ? "" : (string)reader["pic"];
            return info;
        }
        //
        ...
        public VaneInfo[] GetAllVane()
        {
            ...
            try
            {
                db.GetReader(ref reader, "SP_Vane_All");
                while (reader.Read())
                {
                    VaneInfo info = new VaneInfo();
                    info.ID = (int)reader["ID"];
        ...
        public VaneInfo GetSingleVane(int VaneID)
        {
            ...
            try
            {
                ...
                para[0].Value = VaneID;
                db.GetReader(ref reader, "SP_Vane_Single", para);
                while (reader.Read())
                {
        ...
        public DailyLogListInfo GetDailyLogListSingle(int UserID)
        {
            ...
            try
            {
                SqlParameter[] para = new SqlParameter[1];
                para[0] = new SqlParameter("@UserID", UserID);
                db.GetReader(ref reader, "SP_DailyLogList_Single", para);
                while (reader.Read())
                {
                    DailyLogListInfo info = new DailyLogListInfo();
                    info.ID = (int)reader["ID"];
                    info.UserID = (int)reader["UserID"];
                    info.UserAwardLog = (int)reader["UserAwardLog"];
                    info.DayLog = (string)reader["DayLog"];
        ...
        public NpcInfo[] GetAllNPCInfo()
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    info.DropId = (int)reader["DropId"];
                    info.CurrentBallId = (int)reader["CurrentBallId"];
