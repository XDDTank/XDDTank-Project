    ...
    public class PlayerBussiness : BaseBussiness
    {
        public ConsortiaUserInfo[] GetAllMemberByConsortia(int ConsortiaID)
        {
            ...
            try
            {
                ...
                para[0] = new SqlParameter("@ConsortiaID", SqlDbType.Int, 4);
                para[0].Value = ConsortiaID;
                db.GetReader(ref reader, "SP_Consortia_Users_All", para);
                while (reader.Read())
                {
                    infos.Add(InitConsortiaUserInfo(reader));
                }
            }
            catch (Exception e)
            {
        ...
        public bool ActivePlayer(ref PlayerInfo player, string userName, string passWord, bool sex, int gold, int money, string IP, string site)
        {
            ...
            try
            {
                ...
                player.Defence = 0;
                player.Gold = 1000;//gold;
                player.GP = 1;
                player.Grade = 1;
                player.ID = 0;
                player.Luck = 0;
                player.Money = 10000;// money;
                player.NickName = "";
                player.Sex = sex;
                player.State = 0;
                player.Style = ",,,,,,";
                ...
                para[21] = new SqlParameter("@Cash", player.cash);
       ...
       public bool RegisterPlayer(string userName, string passWord, string nickName, string bStyle, string gStyle, string armColor, string hairColor, string faceColor, string clothColor, string hatColor, int sex, ref string msg, int validDate)
        ...
        public PlayerInfo LoginGame(string username, ref int isFirst, ref bool isExist, ref bool isError, bool firstValidate, ref DateTime forbidDate, string nickname, string ActiveIP)
        {
            ...
            try
            {
                ...
                para[4] = new SqlParameter("@ActiveIP", ActiveIP);//ActiveIP
        ...
        public PlayerInfo ReLoadPlayer(int ID)
        {
            ...
            try
            {
                ...
                //para[1] = new SqlParameter("@Password", password);
                db.GetReader(ref reader, "SP_Users_Reload", para);
                while (reader.Read())
                {
                    return InitPlayerInfo(reader);
                }
        ...
        public PlayerInfo InitPlayerInfo(SqlDataReader reader)
        {
            ...
            //player.VIPOnlineDays = (int)reader["VIPOnlineDays"];
            //player.VIPOfflineDays = (int)reader["VIPOfflineDays"];
        ...
        public List<ItemInfo> GetUserEuqipByNick(string Nick)
        {
            ...
            {
                SqlParameter[] para = new SqlParameter[1];
                para[0] = new SqlParameter("@NickName", SqlDbType.NVarChar, 200);
                para[0].Value = Nick;
                db.GetReader(ref reader, "SP_Users_Items_Equip_By_Nick", para);
        ...
        public ItemInfo InitItem(SqlDataReader reader)
        {
            ...
            //-------------
            item.beadExp = (int)reader["beadExp"];
            item.beadLevel = (int)reader["beadLevel"];
            item.beadIsLock = (bool)reader["beadIsLock"];
            item.isShowBind = (bool)reader["isShowBind"];
            ...
            item.Guard = (int)reader["Guard"];
            item.Blood = (int)reader["Blood"];
            item.Bless = (int)reader["Bless"];
            return item;
        }
        ...
        public bool UpdateGoods(ItemInfo item)
        {
            ...
            try
            {
                ...
                //trminhpc
                para[27] = new SqlParameter("@StrengthenTimes", item.StrengthenTimes);
                para[28] = new SqlParameter("@Hole5Level", item.Hole5Level);
                para[29] = new SqlParameter("@Hole5Exp", item.Hole5Exp);
                ...
                para[33] = new SqlParameter("@goldBeginTime", item.goldBeginTime.ToString());
                para[34] = new SqlParameter("@goldValidDate", item.goldValidDate);
                para[35] = new SqlParameter("@StrengthenExp", item.StrengthenExp);

                para[36] = new SqlParameter("@beadExp", item.beadExp);
                para[37] = new SqlParameter("@beadLevel", item.beadLevel);
                para[38] = new SqlParameter("@beadIsLock", item.beadIsLock);
                para[39] = new SqlParameter("@isShowBind", item.isShowBind);
                para[40] = new SqlParameter("@latentEnergyCurStr", item.latentEnergyCurStr);
                para[41] = new SqlParameter("@latentEnergyNewStr", item.latentEnergyNewStr);
                para[42] = new SqlParameter("@latentEnergyEndTime", item.latentEnergyEndTime.ToString());
                para[43] = new SqlParameter("@Damage", item.Damage);
                para[44] = new SqlParameter("@Guard", item.Guard);
                para[45] = new SqlParameter("@Blood", item.Blood);
                para[46] = new SqlParameter("@Bless", item.Bless);
        ...
        public MailInfo InitMail(SqlDataReader reader)
        {
            ...
            info.GiftToken = (int)reader["GiftToken"];
        ...
        public BufferInfo[] GetUserBuffer(int userID)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    info.IsExist = (bool)reader["IsExist"];
                    info.ValidCount = (int)reader["ValidCount"];
                    info.IsDirty = false;
                    infos.Add(info);
                }
            }
        ...
        public bool SaveBuffer(BufferInfo info)
        {
            ...
            try
            {
                ...
                para[7] = new SqlParameter("@Value", info.ValidCount);
        ...
        public AuctionInfo InitAuctionInfo(SqlDataReader reader)
        {
            ...
            info.goodsCount = (int)reader["goodsCount"];
            return info;
        }
        ...
        public HotSpringRoomInfo GetHotSpringRoomInfoSingle(int id)
        {
            ...
            try
            {
                SqlParameter[] sqlParameters = new SqlParameter[] { new SqlParameter("@RoomID", id) };
        ...
        public bool UpdateHotSpringRoomInfo(HotSpringRoomInfo info)
        {
            ...
            try
            {
                ...
                db.RunProcedure("SP_Update_HotSpringRoomInfo", sqlParameters);
                flag = true;//((int)sqlParameters[6].Value) == 0;
            }
            catch (Exception exception)
            {
                if (BaseBussiness.log.IsErrorEnabled)
        ...
        public bool UpdateVIPInfo(PlayerInfo p)
        {
            ...
            try
            {
                SqlParameter[] sqlParameters = new SqlParameter[] { 
                    ...
                    new SqlParameter("@VIPOnlineDays", 0), 
                    new SqlParameter("@VIPOfflineDays", 0),
                    new SqlParameter("@VIPExpireDay", p.VIPExpireDay.ToString()),
                    new SqlParameter("@VIPLastDate", DateTime.Now),
                    new SqlParameter("@VIPNextLevelDaysNeeded", 0),
        ...
        public int VIPRenewal(string nickName, int renewalDays, ref DateTime ExpireDayOut)
        {
            ...
            try
            {
                SqlParameter[] sqlParameters = new SqlParameter[] { 
                    ...
                    new SqlParameter("@ExpireDayOut", DateTime.Now), //@ExpireDayOut
                    new SqlParameter("@Result", SqlDbType.Int) };
        ...
        public LevelInfo[] GetAllLevel()
        {
            ...
            try
            {
                db.GetReader(ref reader, "SP_Level_All");
                while (reader.Read())
                {
        ...
        public ExerciseInfo[] GetAllExercise()
        {
            ...
            try
            {
                db.GetReader(ref reader, "SP_Exercise_All");
                while (reader.Read())
                {
                    ExerciseInfo info = new ExerciseInfo();
                    info.Grage = (int)reader["Grage"];
                    info.GP = (int)reader["GP"];
                    info.ExerciseA = (int)reader["ExerciseA"];
                    info.ExerciseAG = (int)reader["ExerciseAG"];
                    info.ExerciseD = (int)reader["ExerciseD"];
                    info.ExerciseH = (int)reader["ExerciseH"];
                    info.ExerciseL = (int)reader["ExerciseL"]; 
                    infos.Add(info);
                }
            }
            catch (Exception e)
        ...
        public LevelInfo GetUserLevelSingle(int Grade)
        {
            ...
            try
            {
                ...
                db.GetReader(ref reader, "SP_Get_Level_By_Grade", para);
                while (reader.Read())
                {
                    LevelInfo info = new LevelInfo();
                    info.Grade = (int)reader["Grade"];
            ...
            {
                if (log.IsErrorEnabled)
                    log.Error("GetLevelInfoSingle", e);
            }
            finally
            {
                if (reader != null && !reader.IsClosed)
        ...
        public ExerciseInfo GetExerciseSingle(int Grade)
        {
            ...
            {
                SqlParameter[] para = new SqlParameter[1];
                para[0] = new SqlParameter("@Grage", Grade);
                db.GetReader(ref reader, "SP_Get_Exercise_By_Grade", para);
                while (reader.Read())
                {
                    ExerciseInfo info = new ExerciseInfo();
                    info.Grage = (int)reader["Grage"];
            ...
            {
                if (log.IsErrorEnabled)
                    log.Error("GetExerciseInfoSingle", e);
            }
            finally
            {
                if (reader != null && !reader.IsClosed)
        ...
        public TexpInfo GetUserTexpInfoSingle(int ID)
        {
            ...
            try
            {
                SqlParameter[] para = new SqlParameter[1];
                para[0] = new SqlParameter("@UserID", ID);
                db.GetReader(ref reader, "SP_Get_UserTexp_By_ID", para);
                while (reader.Read())
                {
                    TexpInfo info = new TexpInfo();
                    info.UserID = (int)reader["UserID"];
                    info.attTexpExp = (int)reader["attTexpExp"];
                    info.defTexpExp = (int)reader["defTexpExp"];
                    info.hpTexpExp = (int)reader["hpTexpExp"];
                    info.lukTexpExp = (int)reader["lukTexpExp"];
                    info.spdTexpExp = (int)reader["spdTexpExp"];
                    info.texpCount = (int)reader["texpCount"];
                    info.texpTaskCount = (int)reader["texpTaskCount"];
                    info.texpTaskDate = (DateTime)reader["texpTaskDate"];
                    return info;
                }
            }
            catch (Exception e)
        ...
        public bool UpdateUserTexpInfo(TexpInfo info)
        {
            ...
            try
            {
                SqlParameter[] para = new SqlParameter[10];
                para[0] = new SqlParameter("@UserID", info.UserID);
                para[1] = new SqlParameter("@attTexpExp", info.attTexpExp);
                para[2] = new SqlParameter("@defTexpExp", info.defTexpExp);
                para[3] = new SqlParameter("@hpTexpExp", info.hpTexpExp);
                para[4] = new SqlParameter("@lukTexpExp", info.lukTexpExp);
                para[5] = new SqlParameter("@spdTexpExp", info.spdTexpExp);
                para[6] = new SqlParameter("@texpCount", info.texpCount);
                para[7] = new SqlParameter("@texpTaskCount", info.texpTaskCount);
                para[8] = new SqlParameter("@texpTaskDate", info.texpTaskDate.ToString());
                para[9] = new SqlParameter("@Result", System.Data.SqlDbType.Int);
                para[9].Direction = ParameterDirection.ReturnValue;
                db.RunProcedure("SP_UserTexp_Update", para);
        ...
        public bool InsertUserTexpInfo(TexpInfo info)
        {
            ...
            try
            {
                ...
                para[9] = new SqlParameter("@Result", System.Data.SqlDbType.Int);
                para[9].Direction = ParameterDirection.ReturnValue;
                db.RunProcedure("SP_UserTexp_Add", para);
                result = (int)para[9].Value == 0;
            }
            catch (Exception e)
            {
                if (log.IsErrorEnabled)
                    log.Error("InsertTexpInfo", e);
            }
            return result;
        }
        //=============================
        ...
        public bool SaveUserPet(UsersPetinfo info)
        {
            ...
            try
            {
                ...
                para[17] = new SqlParameter("@Level", info.Level);
                para[18] = new SqlParameter("@GP", info.GP);
                para[19] = new SqlParameter("@MaxGP", info.MaxGP);
                para[20] = new SqlParameter("@Hunger", info.Hunger);
                para[21] = new SqlParameter("@PetHappyStar", info.PetHappyStar);
                para[22] = new SqlParameter("@MP", info.MP);
                para[23] = new SqlParameter("@IsEquip", info.IsEquip);
                para[24] = new SqlParameter("@Place", info.Place);
                para[25] = new SqlParameter("@IsExit", info.IsExit);
                para[26] = new SqlParameter("@ID", info.ID);
                para[27] = new SqlParameter("@Skill", info.Skill);
                para[28] = new SqlParameter("@SkillEquip", info.SkillEquip);
                para[29] = new SqlParameter("@Result", System.Data.SqlDbType.Int);
                para[29].Direction = ParameterDirection.ReturnValue;
                db.RunProcedure("SP_UserPet_Update", para);
        ...
        public bool RemoveUserPet(UsersPetinfo info)
        {
            ...
            try
            {
                ...
                para[25] = new SqlParameter("@IsExit", info.IsExit);
                para[26] = new SqlParameter("@ID", info.ID);
                para[27] = new SqlParameter("@Result", System.Data.SqlDbType.Int);
                para[27].Direction = ParameterDirection.ReturnValue;
                db.RunProcedure("SP_UserPet_Remove", para);
        ...
        {
            UsersPetinfo items = new UsersPetinfo();
            SqlDataReader reader = null;
            try
            {
                SqlParameter[] para = new SqlParameter[1];
                para[0] = new SqlParameter("@ID", SqlDbType.Int, 4);
                para[0].Value = PetID;
                db.GetReader(ref reader, "SP_Remove_User_Pet", para);

                while (reader.Read())
                {
                    return InitPet(reader);
                }
            }
            catch (Exception e)
            {
        ...
        public UsersPetinfo GetAdoptPetSingle(int PetID)
        {
            ...
            try
            {
                ...
                para[0] = new SqlParameter("@ID", SqlDbType.Int, 4);
                para[0].Value = PetID;
                db.GetReader(ref reader, "SP_AdoptPet_By_Id", para);
        ...
        public List<UsersPetinfo> GetUserPetIsExitSingles(int UserID)
        {
            ...
            try
            {
                ...
                para[0] = new SqlParameter("@UserID", SqlDbType.Int, 4);
                para[0].Value = UserID;
                db.GetReader(ref reader, "SP_Get_UserPet_By_IsExit", para);
        ...
        public UsersPetinfo InitPet(SqlDataReader reader)
        {
            ...
            info.PetHappyStar = (int)reader["PetHappyStar"];
        ...
        public PetConfig[] GetAllPetConfig()
        {
            ...
            try
            {
                db.GetReader(ref reader, "SP_PetConfig_All");
                while (reader.Read())
                {
                    PetConfig info = new PetConfig();
                    info.ID = (int)reader["ID"];
                    info.Name = (string)reader["Name"].ToString();
                    info.Value = (string)reader["Value"].ToString();
                    infos.Add(info);
                }
            }
            catch (Exception e)
        ...
        public PetLevel[] GetAllPetLevel()
        {
            ...
            try
            {
                db.GetReader(ref reader, "SP_PetLevel_All");
                while (reader.Read())
                {
                    PetLevel info = new PetLevel();
                    info.Level = (int)reader["Level"]; 
                    info.GP = (int)reader["GP"];     
                    infos.Add(info);
                }
        ...
        public PetTemplateInfo[] GetAllPetTemplateInfo()
        {
            ...
            try
            {
                db.GetReader(ref reader, "SP_PetTemplateInfo_All");
                while (reader.Read())
                {
                    PetTemplateInfo info = new PetTemplateInfo();
                    info.ID = (int)reader["ID"];
                    info.TemplateID = (int)reader["TemplateID"];
                    info.Name = (string)reader["Name"].ToString();
                    info.KindID = (int)reader["KindID"];
                    info.Description = (string)reader["Description"].ToString();
                    info.Pic = (string)reader["Pic"].ToString();
                    info.RareLevel = (int)reader["RareLevel"];
                    info.MP = (int)reader["MP"];
                    info.StarLevel = (int)reader["StarLevel"];
                    info.GameAssetUrl = (string)reader["GameAssetUrl"].ToString();
                    info.EvolutionID = (int)reader["EvolutionID"]; 
                    infos.Add(info);
                }
            }
            catch (Exception e)
        ...
        public PetSkillTemplateInfo[] GetAllPetSkillTemplateInfo()
        {
            ...
            try
            {
                db.GetReader(ref reader, "SP_PetSkillTemplateInfo_All");
                while (reader.Read())
                {
                    PetSkillTemplateInfo info = new PetSkillTemplateInfo();
                    info.ID = (int)reader["ID"];     
                    info.PetTemplateID = (int)reader["PetTemplateID"];                    
                    info.KindID = (int)reader["KindID"];
                    info.GetType = (int)reader["GetType"];
                    info.SkillID = (int)reader["SkillID"];
                    info.SkillBookID = (int)reader["SkillBookID"];
                    info.MinLevel = (int)reader["MinLevel"];
                    info.DeleteSkillIDs = (string)reader["DeleteSkillIDs"].ToString();   
                    infos.Add(info);
                }
            }
            catch (Exception e)
            {
                if (log.IsErrorEnabled)
                    log.Error("GetAllPetSkillTemplateInfo", e);
            }
            finally
            {
                if (reader != null && !reader.IsClosed)
        ...
        public PetSkillInfo[] GetAllPetSkillInfo()
        {
            ...
            try
            {
                db.GetReader(ref reader, "SP_PetSkillInfo_All");
                while (reader.Read())
                {
                    PetSkillInfo info = new PetSkillInfo();
                    info.ID = (int)reader["ID"];
                    info.Name = (string)reader["Name"].ToString();
                    info.ElementIDs = (string)reader["ElementIDs"].ToString();
                    info.Description = (string)reader["Description"].ToString();
                    info.BallType = (int)reader["BallType"];
                    info.NewBallID = (int)reader["NewBallID"];
                    info.CostMP = (int)reader["CostMP"];
                    info.Pic = (int)reader["Pic"];
                    info.Action = (string)reader["Action"].ToString();
                    info.EffectPic = (string)reader["EffectPic"].ToString();
                    info.Delay = (int)reader["Delay"];
                    info.ColdDown = (int)reader["ColdDown"];
                    info.GameType = (int)reader["GameType"];
                    info.Probability = (int)reader["Probability"];
                    info.Damage = (int)reader["Damage"];
                    info.DamageCrit = (int)reader["DamageCrit"]; 
                    infos.Add(info);
                }
            }
            catch (Exception e)
            {
                if (log.IsErrorEnabled)
                    log.Error("GetAllPetSkillInfo", e);
            }
            finally
            {
                if (reader != null && !reader.IsClosed)
        ...
        public PetSkillElementInfo[] GetAllPetSkillElementInfo()
        {
            ...
            try
            {
                db.GetReader(ref reader, "SP_PetSkillElementInfo_All");
                while (reader.Read())
                {
                    PetSkillElementInfo info = new PetSkillElementInfo();
                    info.ID = (int)reader["ID"];
                    info.Name = (string)reader["Name"].ToString();
                    info.EffectPic = (string)reader["EffectPic"].ToString();
                    info.Description = (string)reader["Description"].ToString();
            ...
            {
                if (log.IsErrorEnabled)
                    log.Error("GetAllPetSkillElementInfo", e);
            }
            finally
            {
                if (reader != null && !reader.IsClosed)
        ...
        public bool AddCards(UsersCardInfo item)
        {
            ...
            try
            {
                ...
                result = db.RunProcedure("SP_Users_Cards_Add", para);
        ...
        public bool UpdateCards(UsersCardInfo info)
        {
            ...
            try
            {
                ...
                para[0] = new SqlParameter("@CardType", info.CardType);
                para[1] = new SqlParameter("@UserID", info.UserID);
                para[2] = new SqlParameter("@Place", info.Place);
                para[3] = new SqlParameter("@TemplateID", info.TemplateID);
                para[4] = new SqlParameter("@isFirstGet", info.isFirstGet);
                para[5] = new SqlParameter("@Attack", info.Attack);
                para[6] = new SqlParameter("@Defence", info.Defence);
                para[7] = new SqlParameter("@Luck", info.Luck);
                para[8] = new SqlParameter("@Agility", info.Agility);
                para[9] = new SqlParameter("@Damage", info.Damage);
                para[10] = new SqlParameter("@Guard", info.Guard);
                para[11] = new SqlParameter("@IsExit", info.IsExit);
                para[12] = new SqlParameter("@Level", info.Level);
                para[13] = new SqlParameter("@CardGP", info.CardGP);
                para[14] = new SqlParameter("@Type", info.Type);
                para[15] = new SqlParameter("@CardID", info.CardID);                
                para[16] = new SqlParameter("@Result", System.Data.SqlDbType.Int);
                para[16].Direction = ParameterDirection.ReturnValue;
                db.RunProcedure("SP_UserCardProp_Update", para);
        ...
        public List<UsersCardInfo> GetUserCardEuqip(int UserID)
        {
            ...
            try
            {
                ...
                para[0] = new SqlParameter("@UserID", SqlDbType.Int, 4);
                para[0].Value = UserID;
                db.GetReader(ref reader, "SP_Users_Items_Card_Equip", para);

                while (reader.Read())
                {
                    items.Add(InitCard(reader));
                }
            }
            catch (Exception e)
            {
        ...
        public UsersCardInfo GetUserCardByPlace(int Place)
        {
            ...
            {
                SqlParameter[] para = new SqlParameter[1];
                para[0] = new SqlParameter("@Place", SqlDbType.Int, 4);
                para[0].Value = Place;
                db.GetReader(ref reader, "SP_Get_UserCard_By_Place", para);

                while (reader.Read())
                {
                  return InitCard(reader);
                }
            }
            catch (Exception e)
            {
        ...
        public UsersCardInfo[] GetUserCardSingles(int UserID)
        {
            ...
            try
            {
                ...
                para[0] = new SqlParameter("@UserID", SqlDbType.Int, 4);
                para[0].Value = UserID;
                db.GetReader(ref reader, "SP_Get_UserCard_By_ID", para);
        ...
        {
            UsersCardInfo info = new UsersCardInfo();
            info.UserID = (int)reader["UserID"];
            info.TemplateID = (int)reader["TemplateID"];
            info.CardID = (int)reader["CardID"];
            info.CardType = (int)reader["CardType"];
            info.Attack = (int)reader["Attack"];
            info.Agility = (int)reader["Agility"];
            info.Defence = (int)reader["Defence"];
            info.Luck = (int)reader["Luck"];
            ...
            info.Level = (int)reader["Level"];            
            info.Place = (int)reader["Place"];
            info.isFirstGet = (bool)reader["isFirstGet"];
            info.Type = (int)reader["Type"];
            info.CardGP = (int)reader["CardGP"];
            return info;
        }
        public CardGrooveUpdateInfo[] GetAllCardGrooveUpdate()
        {
            ...
            try
            {
                db.GetReader(ref reader, "SP_CardGrooveUpdate_All");
                while (reader.Read())
                {                    
                    infos.Add(InitCardGrooveUpdate(reader));
                }
            }
            catch (Exception e)
            {
                if (log.IsErrorEnabled)
                    log.Error("GetAllCardGrooveUpdate", e);
            }
            finally
            {
                if (reader != null && !reader.IsClosed)
        ...
        {
            CardGrooveUpdateInfo info = new CardGrooveUpdateInfo();
            info.ID = (int)reader["ID"];
            info.Attack = (int)reader["Attack"];
        ...
        public CardTemplateInfo[] GetAllCardTemplate()
        {
            ...
            try
            {
                db.GetReader(ref reader, "SP_CardTemplate_All");
                while (reader.Read())
                {                    
                    infos.Add(InitCardTemplate(reader));
                }
            }
            catch (Exception e)
            {
                if (log.IsErrorEnabled)
                    log.Error("GetAllCardTemplateInfo", e);
            }
            finally
            {
                if (reader != null && !reader.IsClosed)
        ...
        public CardTemplateInfo InitCardTemplate(SqlDataReader reader)
        {
            ...
            info.CardType = (int)reader["CardType"];
            info.probability = (int)reader["probability"];
            info.AttackRate = (int)reader["AttackRate"];
            info.AddAttack = (int)reader["AddAttack"];
            info.DefendRate = (int)reader["DefendRate"];
            info.AddDefend = (int)reader["AddDefend"];
            info.AgilityRate = (int)reader["AgilityRate"];
            info.AddAgility = (int)reader["AddAgility"];
            info.LuckyRate = (int)reader["LuckyRate"];
            info.AddLucky = (int)reader["AddLucky"];
            info.DamageRate = (int)reader["DamageRate"];
            info.AddDamage = (int)reader["AddDamage"];
            info.GuardRate = (int)reader["GuardRate"];
        ...
        public bool AddFarm(UserFarmInfo item)
        {
            ...
            try
            {
                ...
                para[1] = new SqlParameter("@PayFieldMoney", item.PayFieldMoney);
                para[2] = new SqlParameter("@PayAutoMoney", item.PayAutoMoney);
                para[3] = new SqlParameter("@AutoPayTime", item.AutoPayTime.ToString());
                para[4] = new SqlParameter("@AutoValidDate", item.AutoValidDate);
                para[5] = new SqlParameter("@VipLimitLevel", item.VipLimitLevel);
                para[6] = new SqlParameter("@FarmerName", item.FarmerName);
                para[7] = new SqlParameter("@GainFieldId", item.GainFieldId);
                para[8] = new SqlParameter("@MatureId", item.MatureId);
                para[9] = new SqlParameter("@KillCropId", item.KillCropId);
                para[10] = new SqlParameter("@isAutoId", item.isAutoId);
                para[11] = new SqlParameter("@isFarmHelper", item.isFarmHelper);
                para[12] = new SqlParameter("@ID", item.ID);
        ...
        public List<ItemInfo> GetUserBeadEquip(int UserID)
        {
            ...
            try
            {
                ...
                para[0] = new SqlParameter("@UserID", SqlDbType.Int, 4);
                para[0].Value = UserID;
                db.GetReader(ref reader, "SP_Users_Bead_Equip", para);
